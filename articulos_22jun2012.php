...
$query_progs_diplos = sprintf("SELECT * FROM site_programs WHERE program_type = 'diplomado' AND cancelado = 0 AND id_discipline = %s AND id_program IN (SELECT id_program FROM site_fechas_ini WHERE periodo = 'p') ORDER BY program_name ASC", GetSQLValueString($colname_progs_diplos, "int"));
...
mysql_select_db($database_otono2011, $otono2011);
$query_progs_diplos_2 = "SELECT * FROM site_programs WHERE program_type = 'diplomado' AND cancelado = 0 AND id_discipline_alterna != 'NULL' AND id_program IN (SELECT id_program FROM site_fechas_ini WHERE periodo = 'p') ORDER BY program_name ASC";
...
mysql_select_db($database_otono2011, $otono2011);
$query_progs_cursos = sprintf("SELECT * FROM site_programs WHERE program_type = 'curso' AND cancelado = 0 AND id_discipline = %s AND id_program IN (SELECT id_program FROM site_fechas_ini WHERE periodo = 'p') ORDER BY idioma ASC, program_name ASC", GetSQLValueString($colname_progs_cursos, "int"));
...
mysql_select_db($database_otono2011, $otono2011);
$query_progs_cursos_2 = "SELECT * FROM site_programs WHERE program_type = 'curso' AND cancelado = 0 AND id_discipline_alterna != 'NULL' AND id_program IN (SELECT id_program FROM site_fechas_ini WHERE periodo = 'p') ORDER BY idioma ASC, program_name ASC";
...
mysql_select_db($database_otono2011, $otono2011);
$query_progs_cursos_i = "SELECT * FROM site_programs WHERE program_type = 'curso' AND idioma = 1 AND cancelado = 0 AND id_discipline = ".$_GET['id_discipline']." AND id_program IN (SELECT id_program FROM site_fechas_idiomas WHERE periodo = 'v') ORDER BY idioma ASC, program_name ASC";
            ...
            <td align="right" valign="top"><!-- InstanceBeginEditable name="programas" --><div id="menu_programas">
                ...
                <?php do { ?>
                    ...
                    <li >
                      ...
                      <a href="#" onclick="parent.location='http://www.diplomados.uia.mx/programas.php?id_discipline=<? echo $_GET['id_discipline']; ?>&id_program=<? echo $row_progs_cursos['id_program']; ?>'"><? echo $row_progs_cursos['program_name'];  ?>  <? if($row_progs_cursos['program_new']==1){echo '<span class="contenido_diploRojo"> Nuevo </span> ';}else if($row_progs_cursos['program_new']==2){echo '<span class="contenido_diploRojo"> Nueva versión </span> ';}?> </a> </li>
                    ...
                    <li><a href="#" onclick="parent.location='http://www.diplomados.uia.mx/programas.php?id_discipline=<? echo $_GET['id_discipline']; ?>&id_program=<? echo $row_progs_cursos_2['id_program']; ?>'">*<? echo $row_progs_cursos_2['program_name'];  ?>  <? if($row_progs_cursos_2['program_new']==1){echo '<span class="contenido_diploRojo"> Nuevo </span> ';}else if($row_progs_cursos_2['program_new']==2){echo '<span class="contenido_diploRojo"> Nueva versión </span> ';}?> </a></li>
				  ...
				  <?
					...
					do {?>
					<li>
				  <a href="#" onclick="parent.location='http://www.diplomados.uia.mx/idiomas.php?id_discipline=<? echo $_GET['id_discipline']; ?>&id_program=<? echo $row_progs_cursos_i['id_program']; ?>'"><? echo $row_progs_cursos_i['program_name'].'<span class="contenido_diploRojo"> Verano</span>'; ?><? if($row_progs_cursos_i['program_new']==1){echo '<span class="contenido_diploRojo"> Nuevo </span> ';}else if($row_progs_cursos_i['program_new']==2){echo '<span class="contenido_diploRojo"> Nueva versión </span> ';}?></a></li>
        ...
        <table width="93%" border="0" align="center" cellpadding="5" cellspacing="0">
          <tr>
            <td width="80%" valign="middle" class="titulos_diplo"><span class="ruta"> <?php echo $row_temp['discipline'];?> /
              <?php if($row_disciplines['type'] == 0){echo 'Entrevista';}else{echo 'Artículo';}?>
              </span></td>
          ...
          <tr>
            <td height="0" class="titulos_diplo"><?php echo $row_disciplines['title'];?></td>
            <td height="0" align="right" valign="top" style="font-family:Helvetica, Arial, 'Gill Sans'; color:#666;"> - <a style="cursor:pointer; font-size:12px;" onclick="setActiveStyleSheet('estilos_txt'); return false;">A</a> <a style="cursor:pointer; font-size:14px;" onclick="setActiveStyleSheet('estilos_txt2'); return false;">A</a> <a style="cursor:pointer; font-size:16px;" onclick="setActiveStyleSheet('estilos_txt3'); return false;">A</a> + </td>
          </tr>
          <tr>
