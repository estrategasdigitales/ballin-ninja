...
<script type="text/javascript">
	...
	{	
		...
		if(lastHeight != newHeight){
			...
			helperIframe.contentWindow.location.replace('helper.html#' + newHeight);
	...
	function showMenu(discipline, program){
		...
		$.post('show_discipline.php', {disciplina : discipline, programa : program}, function(data){
			...
			switch(discipline){
				...
				break;
				case 14: 
					$('div#slide_menu').css('top', '20px')
				break;
				case 16: 
					$('div#slide_menu').css('top', '26px')
				break;
				case 17: 
					$('div#slide_menu').css('top', '444px')
				break;
				case 20: 
					$('div#slide_menu').css('top', '27px')
				break;
				case 23: 
					$('div#slide_menu').css('top', '199px')
				break;
				default: 
...
<body>
<!--//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
<iframe id="helperIframe" src='helper.html#1000' height='0' width='0' frameborder='0'></iframe>
<!--//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
      ...
      <div id="menu_desplega_index">
        <div id="menu_areas">
          ...
          <ul>
            ...
            <li><a class="discipline_7" onclick="showMenu(7)">Pol&iacute;tica
              y Derecho</a></li>
            <li><a class="discipline_5" onclick="showMenu(5)">Desarrollo
              Humano</a></li>
            ...
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/programas.php?id_discipline=18&id_program=323'">Ciencias Religiosas</a-->
            	<a href="http://www.diplomados.uia.mx/programas.php?id_discipline=18&id_program=323">Ciencias Religiosas</a>
            </li>
         ...
         <h4>Programas impartidos <br />
          ...
          <ul>
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=23'">Oferta Académica</a-->
            	<a class="discipline_23" onclick="showMenu(23)">Oferta Académica</a>
            </li>
          </ul>
          <h4>Centros de Atención Especializada</h4>
          <ul>
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=14'">Idiomas</a-->
            	<a class="discipline_14" onclick="showMenu(14)">Idiomas</a>
            </li>
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=15'">Ibero Online</a-->
            	<a class="discipline_15" onclick="showMenu(15)">Ibero Online</a>
            </li>
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=16'">Atenci&oacute;n Integral a Empresas</a-->
              <a class="discipline_16" onclick="showMenu(16)">Atenci&oacute;n Integral a Empresas</a>
          	</li>
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=17'">Atenci&oacute;n Integral al Sector P&uacute;blico</a-->
            	<a class="discipline_17" onclick="showMenu(17)">Atenci&oacute;n Integral al Sector P&uacute;blico</a>
            </li>
          </ul>
          <h4>Sedes Externas</h4>
          <ul>
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/programas.php?id_discipline=20&id_program=195'">Sede sur: Estudio Lofft</a-->
            	<a class="discipline_20" onclick="showMenu(20)">Sede sur: Estudio Lofft</a></li>
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=13'">Xochitla</a-->
            	<a class="discipline_13" onclick="showMenu(13)">Xochitla</a></li>
  ...
  <div id= "contenedor_irregular_index">
	...
	<div style="margin-left:29px">
				...
				<div id="foo5" class="foo5">
	       			<div class="slide" id="parrafo1">
						...
						<div style="width:172px">
							<h4 align="center">La Ibero y Hewlett-Packard, más de 10 años sumando esfuerzos</h4>
							<hr id="linea1" style="margin-left:10px">
							<p align="center">En este periodo ofertamos seis programas en el área de Tecnología.</p>
						</div>
					</div>
	      			 <div class="slide">
						...
						<div style="width:172px">
							...
							<hr id="linea1" style="margin-left:10px">
							<p align="center">“Para ser líder,  no tienes que ser perfecto” Liderazgo en organizaciones y empresas </p>
						</div>
					</div>
					<div class="slide">
						<img src="http://www.dec-uia.com/otono_2011/imagenes/carrusel/carrusel3.jpg" alt="carousel 3" width="775" height="300" />
						<div style="width:172px";>
							<h4 align="center">“Donde la iluminación, el espacio y el diseño se encuentran”</h4>
							<hr id="linea1" style="margin-left:10px">
							<p align="center">Diplomado Diseño y Luz, en colaboración con Philips</p>
						</div>
					</div>
					<div class="slide">
						...
						<div style="width:172px">
							...
							<hr id="linea1" style="margin-left:10px">
							<p align="center">Gracias a nuestros alumnos por su empeño y dedicación</p>
						</div>
					</div>
				</div>
        ...
        <div style="width:69%;float:left;margin-left:0px">
        	<div id="slide_search" style="border: 1px solid #E0E0E0; display:none; position:relative; margin-top:-142px; top:520px; left:-39px; width:192px; height:140px; background-color:#FFF; z-index:1000;">
				<form name="buscador" action="resultados_adrian.php" method="post">
					<label for="buscar"></label>
				    <img src="imagenes/piquito_rojo_buscador.png">
				    <img src="imagenes/lupa_buscador.jpg">
				    <input name="buscar" placeholder="" type="text" id="buscar" style="margin:0px; width:138px; height:11px; padding:1px; border:1px solid #999999; line-height:0; font-size:11px;"  />
