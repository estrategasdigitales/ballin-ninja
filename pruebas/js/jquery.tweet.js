(function($) {
  ...
  $.fn.tweet = function(o){
    var s = {
      username: ["DiplomadosIbero"],                // [string]   required, unless you want to display our tweets. :) it can be an array, just do ["username1","username2","etc"]
    ...
    $.fn.extend({
        ...
        this.each(function() {
          returning.push(this.replace(regexp,
                                      function(match) {
                                        ...
                                        return "<a href=\""+url+"\" target=\"_parent\">"+match+"</a>";
                                      }));
        });
        return $(returning);
      },
      linkUser: function() {
        ...
        this.each(function() {
          returning.push(this.replace(regexp,"<a href=\"http://"+s.twitter_url+"/$1\" target=\"_blank\">@$1</a>"));        });
        return $(returning);
      },
      linkHash: function() {
        var returning = [];
