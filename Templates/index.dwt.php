...
<div id="container">
  ...
  <div id= "contenedor_irregular_index" >
    <div class="bannersuperior"><!-- TemplateBeginEditable name="weekly_articles" -->weekly_articles<!-- TemplateEndEditable --> </div>
    <div id="separador"></div>
    <div id= "type4" class="rectangulo_abajo_index">
      <div class="textos">
        <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
          <tr>
            <td><!-- TemplateBeginEditable name="contenido" -->contvxenivcvvbdo<!-- TemplateEndEditable --></td>
          </tr>
          <tr>
