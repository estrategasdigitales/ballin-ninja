...
<div id="container">
      ...
      <div id="menu_desplega">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td align="right" valign="top"><!-- TemplateBeginEditable name="programas" --><!-- TemplateEndEditable -->
  ...
  <div id= "contenedor_irregular" >
    <div id= "type4" class="ancho_irregular">
      <div class="textos">
        <table width="100%" border="0" align="left" cellpadding="5" cellspacing="10">
          <tr>
            <td><!-- TemplateBeginEditable name="contenido" -->conenixvdo<!-- TemplateEndEditable --></td>
          </tr>
          <tr>
    ...
    <div id= "type4" class="rectangulo_irregular">
      <div class="header_contenido" style="background:url(imagenes/headers_colores/photo_iframe_header_<?php echo $header; ?>.gif) right bottom no-repeat;"><!-- TemplateBeginEditable name="content_header" -->contentxzc_heaer<!-- TemplateEndEditable --></div>
      <div class="corner topRight"></div>
      <div class="corner bottomRight"></div>
