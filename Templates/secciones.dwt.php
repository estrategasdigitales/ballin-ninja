...
<div id="container">
  ...
  <div id= "contenedor_irregular_index" >
    <div id= "type4" class="cuadro_articulos_secciones">
      <div style="position:relative; float:left; z-index:12;"> <!-- TemplateBeginEditable name="header" -->heaesdczxcr<!-- TemplateEndEditable --> </div>
      <div class="corner topLeft"></div>
      <div class="corner topRight"></div>
      <div class="corner bottomRight"></div>
    </div>
    <div id= "type4" class="rectangulo_abajo_secciones">
      <div class="textos"><!-- TemplateBeginEditable name="contenido" -->cotenido<!-- TemplateEndEditable -->
