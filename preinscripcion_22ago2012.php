    ...
    <div id= "type4" class="rectangulo_abajo_secciones">
      <div class="textos"><!-- InstanceBeginEditable name="contenido" -->
        <table width="95%" border="0" align="center" cellpadding="10" cellspacing="0">
          <tr>
            <td valign="bottom"><h1>Formato
                de Preinscripci&oacute;n</h1>
              ...
              <p>A trav&eacute;s de este formulario podr&aacute;s iniciar tu proceso de inscripci&oacute;n desde la comodidad de tu casa y/o oficina. Una vez llenado el formato, te contactaremos a la brevedad para darte los pasos a seguir y quedar inscrito en el programa de tu inter&eacute;s.</p></td>
            <td width="4%">&nbsp;</td>
          </tr>
          <tr>
            <td colspan="2"><table width="100%" border="0" align="left" cellpadding="2">
                <tr>
                  <td width="90%" height="30" align="left" valign="middle"><h1>Preinscripci&oacute;n</h1></td>
                </tr>
                <tr>
                  <td height="30" align="left" valign="middle"><form id="form1" name="form1" method="post" action="preinscripcion.php" onsubmit="return validate();">
				...
				<select name="fechas_ini" id="fechas_ini">
				  ...
				  if($rows_cursos_2 > 0) {
					  ...
					  $row_cursos_names_2 = mysql_fetch_assoc($cursos_names_2);
                        ...
                        <tr>
                          <td align="right">Deseo recibir noticias<br />
