			  ...
			  <?php 
				...
				<tr>
                    <td><p>
						...
						echo "Ir al ";
						mysql_select_db($database_otono2011, $otono2011);
						$query_progs = sprintf("SELECT program_type, id_discipline, program_name, id_encargado FROM site_programs WHERE id_program = %s", GetSQLValueString($row_media_article_details['id_program'] , "int"));
