...
Programs</h4>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="130" class="fondoBanners"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="34%" height="130" valign="top"><img src="imagenes/banners/redes.png" width="123" height="142" border="0" align="left" usemap="#Map2" class="banner_bottom" /></td>
                <td width="32%" height="130" valign="top"><a href="#" onclick="parent.location='http://www.diplomados.uia.mx/promociones.php'"><img class="banner_bottom" src="imagenes/banners/promociones.png" width="116" height="139" border="0" align="top" /></a></td>
              </tr>
            </table></td>
        </tr>
      </table>
  ...
  <div id= "contenedor_irregular" >
      ...
      <div class="textos">
        <table width="100%" border="0" align="left" cellpadding="5" cellspacing="10">
      	...
      	<table width="100%" border="0" align="left" cellpadding="0" cellspacing="5">
      		<tr>
            <td>
             <?php echo $row_progs_diplos_2['program_new']; ?>
            </td>
            </tr><tr>
            ...
            <? } ?>
      		...
      		<tr>
				...
				<table width="100%" border="0" align="center" cellpadding="3" valign="top"  cellspacing="0">
                      ...
                      </tr><!--para este programa en especifico se tiene que mostrar que esta abierto, pero en la base no tiene fecha-->
                      <?php  }else if($_GET['id_discipline'] == 10 && $_GET['id_program'] == 218){ ?>
                      <tr>
                        <td align="right" valign="top" class="contenido_diploRojo">Inicio</td>
                        <?php if($row_programa['program_colaboracion'] == NULL || $row_programa['program_colaboracion_img'] == NULL){ ?>
                        <td width="2%" rowspan="9" class="linea_separadora_g"></td>
					...
					if($row_programa['costo_curso']!=NULL || $row_programa['cost_inscripcion']!=NULL || $row_programa['costo_modulo']!=NULL){?>
                      <tr>
						...
						}else if($_GET['id_discipline'] == 10 && $_GET['id_program'] == 218){
							echo $row_programa['cost_inscripcion'];
						}else{
							echo '-';
						}
					}?></td>
					...
					if($totalRows_fecha_ini != 0){
                      ...
                      <tr>
                        ...
                        <td align="right" valign="top" class="contenido_diploRojo" <?php if($_GET['id_discipline'] == 15 && $_GET['id_program'] == 401){ ?> style="display:none;" <? } ?>>
            ...
            <? } ?>
                        ...
                        <td <?php if($_GET['id_discipline'] == 15 && $_GET['id_program'] == 401){ ?> style="display:none;" <? } ?>><? if($_GET['id_discipline']==21){ ?>
                          <a href="http://www.ibero-asuncion.mx/inscripciones.php" target="_blank">Formato de Preinscripci&oacute;n</a>
                          <?php }else if($_GET['id_discipline'] == 15 && $_GET['id_program'] == 401){ ?>
	...
	<?php
		if(($row_programa['program_type']=="programahp") && ($row_programa['program'] == "diplomado")){
			
			
		echo "Diplomado";	
			
		}elseif(($row_programa['program_type']=="programahp") && ($row_programa['program'] == "curso")){
