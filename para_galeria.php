        ...
        <table width="100%" border="0" align="left" cellpadding="5" cellspacing="10">
          <tr>
            <td><!-- InstanceBeginEditable name="contenido" -->
              <table width="100%" border="0" align="center" cellpadding="5" cellspacing="10" class="bg_galeria">
                <tr>
                  <td ><div id="td_01" class="galeria" >
                      <table  border="0" cellspacing="0" cellpadding="0" >
                        <tr >
                          <td ><img src="imagenes/uploads/galeria/loft_1.jpg" width="338" height="198" /></td>
                        </tr>
                      </table>
                    </div>
                    <div id="td_02" class="galeria" >
                      <table  border="0" cellspacing="0" cellpadding="0" >
                        <tr >
                          <td ><img src="imagenes/uploads/galeria/loft_2.jpg" width="338" height="198" /></td>
                        </tr>
                      </table>
                    </div>
                    <div id="td_03" class="galeria" >
                      <table  border="0" cellspacing="0" cellpadding="0" >
                        <tr >
                          <td ><img src="imagenes/uploads/galeria/loft_3.jpg" width="338" height="198" /></td>
                        </tr>
                      </table>
                    </div>
                    <table width="100%" border="0" cellspacing="0" cellpadding="2">
                      <tr>
                        <td><a href="#" id="td_01" class="btn"><img src="imagenes/uploads/galeria/loft_1.jpg" width="110" height="70" border="0" /></a></td>
                        <td><a href="#" id="td_02" class="btn"><img src="imagenes/uploads/galeria/loft_2.jpg" alt="" width="110" height="70" /></a></td>
                        <td><a href="#" id="td_03" class="btn"><img src="imagenes/uploads/galeria/loft_3.jpg" alt="" width="110" height="70" border="0" /></a></td>
                      </tr>
                    </table></td>
                </tr>
              </table>
