...
*/
	function showMenu(discipline){

		$.post('show_discipline.php', {disciplina: discipline}, function(data){
			if($('div#slide_menu:visible')){
				$('div#slide_menu').hide(100)
			}
			$('div#slide_menu').empty().toggle(100).append(data)
		})
	}
	...
	$('body:not("#slide_menu")').live('click', function(){
...
/*
    $('document:not(div#slide_menu)').live('click', function(){alert('entro')})
*/
/*
	$('div#slide_menu:not').live('click', function(){
...
<div id="container">
    ...
    <div class="roundedBox_interior_index" id="type1"> 
      ...
      <div id="menu_desplega_index">
        <div id="menu_areas">
          ...
          <ul>
            <li> <!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=1'"> </a--><a href="#" class="hola" onclick="showMenu(1)">Arquitectura</a></li>
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=2'"> Arte</a--><a href="#" onclick="showMenu(2)">Arte</a></li>
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=3'"> Diseño</a--><a href="#" onclick="showMenu(3)">Diseño</a></li>
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=7'">Pol&iacute;tica
              y Derecho</a--><a href="#" onclick="showMenu(7)">Pol&iacute;tica
              y Derecho</a></li>
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=5'">Desarrollo
              Humano</a--><a href="#" onclick="showMenu(5)">Desarrollo
              Humano</a></li>
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=6'">Salud</a--><a href="#" onclick="showMenu(6)">Salud</a></li>
            ...
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=8'">Negocios</a--><a href="#" onclick="showMenu(8)">Negocios</a></li>
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=9'">Tecnolog&iacute;a</a--><a href="#" onclick="showMenu(9)">Tecnolog&iacute;a</a></li>
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=10'">Humanidades</a--><a href="#" onclick="showMenu(10)">Humanidades</a></li>
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/programas.php?id_discipline=18&id_program=323'">Ciencias
              Religiosas</a--><a href="#" onclick="showMenu(18)">Ciencias Religiosas</a></li>
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=11'">Gastronom&iacute;a</a--><a href="#" onclick="showMenu(11)">Gastronom&iacute;a</a></li>
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=12'">Preparatoria
              Abierta</a--><a href="#" onclick="showMenu(12)">Preparatoria Abierta</a></li>
          </ul>
         <h4>Programas impartidos <br />
                por Harvard University</h4>
          <ul>
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=23'">Oferta Académica</a--><a href="#" onclick="showMenu(1)">Arquitectura</a></li>
          </ul>
          <h4>Centros de Atención Especializada</h4>
          <ul>
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=14'">Idiomas</a--><a href="#" onclick="showMenu(1)">Arquitectura</a></li>
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=15'">Ibero Online</a--><a href="#" onclick="showMenu(1)">Arquitectura</a></li>
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=16'">Atenci&oacute;n Integral
              a Empresas</a--><a href="#" onclick="showMenu(1)">Arquitectura</a></li>
            <li><!--a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=17'">Atenci&oacute;n Integral al Sector P&uacute;blico</a--><a href="#" onclick="showMenu(1)">Arquitectura</a></li>
          </ul>
  ...
  <div id= "contenedor_irregular_index" >
    ...
    <div id="separador"></div>
     <div id="slide_menu" style="display:none; width:190px; background-color:#D6D7D9; position:relative; top:-10px; left:-11px; z-index:1000; margin-bottom:-1000px">
