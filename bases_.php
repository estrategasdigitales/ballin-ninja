...
<div id="container">
  <div id="header">
    <div id="logos"> <a href="http://uia.mx/" target="_blank"><img src="imagenes/logo_UIA.jpg" alt="logo" width="100" height="78" border="0" class="logo"/></a><a href="#" onclick="parent.location='index.php'"><img src="imagenes/logo_DEC.jpg" alt="DEC" width="90" height="78" border="0" /></a></div>
		 ...
		 num_amigo=2;
            function form_amigo(){
            	 $(".add_amigo").remove()
            	  $("#submit").remove()
                if(num_amigo<4){
                    $("#contenedor_forms form").append("<div id=amigo"+num_amigo+" style='margin-right: 10px'>")
                    $("#amigo"+num_amigo+"").prepend("<div class='datos'>")
                    $("#amigo"+num_amigo+" .datos").append("<span style=color:#ec1c23;font-size: 20px;>Regístra a tu amigo<br></span>")
                    $("#amigo"+num_amigo+" .datos").append("<label style='margin-right:60px'>* Nombre(s):</label><label style='margin-right:35px'>* Apellido paterno</label><label>* E-mail</label><br>")
                    ...
                    $("#amigo"+num_amigo+" .datos").append("<input type=button value='Registrar otro amigo' class='add_amigo'>")
                    $("#amigo"+num_amigo+" .datos").append("<input type='submit' value='Finalizar Registro' id='submit'>")
                    num_amigo+=1
                }
                if(num_amigo==4){
                    $(".add_amigo").remove()
	...
	<div id= "contenedor_irregular_index">
		<?php
			$alerta=$_GET["success"];
 			if($alerta==1){
		?>
					      			<div class="body" style="background-image:url(imagenes/confirmacion.jpg);width: 775px;height: 600px;margin-left: 34px; background-size: 100%;background-repeat: no-repeat;">
					      			</div>
 	<?php
 	}
 	else{
 ?>
	  <img src="banner_pagina_formulario.png">
	   <!--<p style="width: 70%;">*Descuento no acumulable con otras promociones. *Promocion válida del 11 al 14 de febrero de 2013.
	  	*Aplica en diferentes programas.  *No aplica descuento para quienes ya estén inscritos.  *Aplica sobre el costo total del programa.
	  	*Valido para todos los programas primavera 2013.</p>-->
	  	<div id="contenedor_forms" style="width: 570px; margin: 10px 0px 0px 20px; top: 0px; position:relative; height: 215px;">
...
&bull;&nbsp;&nbsp; &nbsp;Los descuentos aplican exclusivamente para quienes cumplan los 2 requisitos en los tiempos definidos en la presente base. No aplica para inscripciones realizadas antes o despu&eacute;s de este periodo.</p>

			<!--form action="landing_snvalentin/get_data.php" method="post"  style="width: 100%;margin-left: 110px;background:url(imagenes/preventivo_pagina.png);height: 219px; background-repeat: no-repeat;"-->
	  			<!--<div id="usuario" style="margin-right: 10px">
						         	<div class="datos">
										<span style="color:#ec1c23;font-size: 15px;">Regístrate para asegurar tu lugar en la promoción.<br></span>
										<label style="margin-right:60px">* Nombre(s):</label><label style="margin-right:35px">* Apellido paterno</label><label>* E-mail</label><br>
										<input type="text" name="nombre" style="float:left">
										<input type="text" name="A_paterno">
										<input type="text" name="mail">
										<p>*Campo obligatorios</p>
									</div>

				</div>
				<div id="amigo1" style="margin-right: 10px">
					         	<div class="datos">
									<span style="color:#ec1c23;font-size: 15px;">Regístra a tu amigo.<br></span>
									<label style="margin-right:60px">* Nombre(s):</label><label style="margin-right:35px">* Apellido paterno</label><label>* E-mail</label><br>
				...
				<input type="button" value="Registrar otro amigo" class="add_amigo"><input type="submit" value="Finalizar Registro" id="submit">-->
			</form>
		</div>
