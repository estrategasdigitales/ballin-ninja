...
$query_weekly_article = "SELECT * FROM weekly_articles WHERE id_article = ".$_GET['id_article']." ORDER BY `date` DESC LIMIT 0, 1";
    ...
    <div id= "type4" class="cuadro_articulos_secciones">
      <div style="position:relative; float:left; z-index:12;"> <!-- InstanceBeginEditable name="header" -->
        <table width="100%" cellpadding="10">
          ...
          <tr>
            <td><a onclick="parent.location='http://www.diplomados.uia.mx/weekly_articles.php'" style="cursor:pointer;"><img src="imagenes/buttons/historico_entrevistas.gif" onmouseover="this.src='imagenes/buttons/historico_entrevistas_onhover.gif'" onmouseout="this.src='imagenes/buttons/historico_entrevistas.gif'" name="img_readmore" id="img_readmore" border="0"></a></td>
          </tr>
        </table>
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td valign="top"><img src="imagenes/uploads/weekly_articles/<?php echo $row_weekly_article['thumbnail']; ?>" width="160" height="152" /></td>
            <td style="padding-left:20px;">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td ><p class="contenido_diploRojo"><strong><?php echo $row_weekly_article['title']; ?></strong></p>
                    <p><strong><?php echo $row_weekly_article['interviewee_name']; ?></strong><br />
                      <?php 
					echo strftime("%d de %B de %Y", strtotime($row_weekly_article['date']));
						?>
                    </p>
                ...
                <tr>
                  <td ><p> <?php echo $row_weekly_article['content']; ?> </p></td>
                </tr>
			  <?php 
				if($row_weekly_article['id_program'] != NULL) 
				{ 
				?>
				<tr>
                  <td>
						...
						echo $row_prog_tipo['program_type']; ?>
						  <a onclick="parent.location='http://www.diplomados.uia.mx/programas.php?id_discipline=<?php echo $row_prog_tipo['id_discipline'];?>&id_program=<?php echo $row_weekly_article['id_program'];?>'" href="" > <strong><?php echo $row_prog_tipo['program_name'];?></strong> </a>
						</p>
				  </td>
                </tr>
                <tr>
                  <td id="encrgados_test">
				  <p>Para mayores informes e inscripciones </p>
                   ...
                   <p> <?php echo $row_prog_enc['nombre']; ?><br />
                    ...
                    <a href="mailto:<?php echo $row_prog_enc['correo']; ?>"><?php echo $row_prog_enc['correo']; ?></a>
                    </p>
					<? } ?>
                    </td>
                </tr>
