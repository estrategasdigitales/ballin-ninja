    ...
    <?php $random=rand(1,2); ?>
      ...
      <table width="100%" border="0" cellspacing="10" cellpadding="0">
       ...
       <?php } else{?>
          ...
          <td valign="middle" style="background: url(imagenes/uploads/banner_prox/<?php echo $row_programas_der['imagen_idioma']; ?>) no-repeat top left; width:160px; height:83px; padding-left:181px; margin-top:5px; padding-right:3px;"><a href="#" onclick="parent.location='http://www.diplomados.uia.mx/programas.php?id_discipline=14&id_program=<?php echo $row_programas_der['id_program_idioma']; ?>'"><h5><?php echo ucfirst(strtolower($row_programas_der['nivel'])); ?></h5></a>
