...
$query_progs_diplos = sprintf("SELECT * FROM seg_dec_programas WHERE program_type = 'diplomado' AND cancelado = 0 AND id_discipline = %s AND id_program IN (SELECT id_program FROM site_fechas_ini WHERE periodo = 'o') ORDER BY program_name ASC", GetSQLValueString($colname_progs_diplos, "int"));
...
mysql_select_db($database_otono2011, $otono2011);
$query_progs_diplos_2 = "SELECT * FROM seg_dec_programas WHERE program_type = 'diplomado' AND cancelado = 0 AND id_discipline_alterna != 'NULL' AND id_program IN (SELECT id_program FROM site_fechas_ini WHERE periodo = 'o') ORDER BY program_name ASC";
...
mysql_select_db($database_otono2011, $otono2011);
$query_progs_cursos = sprintf("SELECT * FROM seg_dec_programas WHERE program_type = 'curso' AND cancelado = 0 AND id_discipline = %s AND id_program IN (SELECT id_program FROM site_fechas_ini WHERE fecha >= '2013-00-00' AND periodo = 'p') ORDER BY idioma ASC, program_name ASC", GetSQLValueString($colname_progs_cursos, "int"));
...
mysql_select_db($database_otono2011, $otono2011);
$query_progs_cursos_2 = "SELECT * FROM seg_dec_programas WHERE program_type = 'curso' AND cancelado = 0 AND id_discipline_alterna != 'NULL' AND id_program IN (SELECT id_program FROM site_fechas_ini WHERE fecha >= '2013-00-00' AND periodo = 'p') ORDER BY idioma ASC, program_name ASC";
...
mysql_select_db($database_otono2011, $otono2011);
$query_progs_cursos_i = "SELECT * FROM seg_dec_programas WHERE program_type = 'curso' AND idioma = 1 AND cancelado = 0 AND id_discipline = ".$_GET['id_discipline']." AND id_program IN (SELECT id_program FROM site_fechas_idiomas WHERE inicio >= '2013-00-00' AND periodo = 'p') ORDER BY idioma ASC, program_name ASC";
...
mysql_select_db($database_otono2011, $otono2011);
$query_programa = "SELECT * FROM seg_dec_programas WHERE id_program = ".$_GET['id_program'];
...
mysql_select_db($database_otono2011, $otono2011);
$query_fecha_ini = "SELECT * FROM site_fechas_idiomas WHERE id_program = ".$_GET['id_program']." AND periodo = 'p'";
            ...
            <td align="right" valign="top"><!-- InstanceBeginEditable name="programas" -->
              <div id="menu_programas">
                ...
                <ul class="lista_programas">
                  ...
                  <li><a href="#" onclick="parent.location='http://www.diplomados.uia.mx/programas.php?id_discipline=<?php echo $_GET['id_discipline']; ?>&amp;id_program=<?php echo $row_progs_diplos['id_program']; ?>&titulo=<? echo $titulo; ?>'"><?php echo $row_progs_diplos['program_name']; ?>
                    <? if($row_progs_diplos['program_new']==1){echo '<span class="contenido_diploRojo"> Nuevo </span> ';}else if($row_progs_diplos['program_new']==2){echo '<span class="contenido_diploRojo"> Nueva versión </span> ';}?>
                    </a></li>
                  ...
                  <li><a href="#" onclick="parent.location='http://www.diplomados.uia.mx/programas.php?id_discipline=<? echo $_GET['id_discipline']; ?>&id_program=<? echo $row_progs_diplos_2['id_program']; ?>'">*<? echo $row_progs_diplos_2['program_name'];  ?>
                    <? if($row_progs_diplos_2['program_new']==1){echo '<span class="contenido_diploRojo"> Nuevo </span> ';}else if($row_progs_diplos_2['program_new']==2){echo '<span class="contenido_diploRojo"> Nueva versión </span> ';}?>
                    </a></li>
                ...
                <ul class="lista_programas">
                  <?php do { ?>
                    <li >
                      ...
                      <a href="#" onclick="parent.location='http://www.diplomados.uia.mx/programas.php?id_discipline=<? echo $_GET['id_discipline']; ?>&id_program=<? echo $row_progs_cursos['id_program']; ?>'"><? echo $row_progs_cursos['program_name'];  ?>
                      <? if($row_progs_cursos['program_new']==1){echo '<span class="contenido_diploRojo"> Nuevo </span> ';}else if($row_progs_cursos['program_new']==2){echo '<span class="contenido_diploRojo"> Nueva versión </span> ';}?>
                      </a> </li>
                    <? } ?>
                    ...
                    <li><a href="#" onclick="parent.location='http://www.diplomados.uia.mx/programas.php?id_discipline=<? echo $_GET['id_discipline']; ?>&id_program=<? echo $row_progs_cursos_2['id_program']; ?>'">*<? echo $row_progs_cursos_2['program_name'];  ?>
                      <? if($row_progs_cursos_2['program_new']==1){echo '<span class="contenido_diploRojo"> Nuevo </span> ';}else if($row_progs_cursos_2['program_new']==2){echo '<span class="contenido_diploRojo"> Nueva versión </span> ';}?>
                      </a></li>
                    <?php } } } while ($row_progs_cursos_2 = mysql_fetch_assoc($progs_cursos_2)); ?>
                  <? do {?>
                    <li> <a href="#" onclick="parent.location='http://www.diplomados.uia.mx/idiomas.php?id_discipline=<? echo $_GET['id_discipline']; ?>&id_program=<? echo $row_progs_cursos_i['id_program']; ?>'"><? echo $row_progs_cursos_i['program_name']; ?>
                      <? if($row_progs_cursos_i['program_new']==1){echo '<span class="contenido_diploRojo"> Nuevo </span> ';}else if($row_progs_cursos_i['program_new']==2){echo '<span class="contenido_diploRojo"> Nueva versión </span> ';}?>
                      </a></li>
          ...
          <tr>
            <td><!-- InstanceBeginEditable name="contenido" -->
              ...
              <table width="100%" border="0" align="left" cellpadding="0" cellspacing="5">
                <tr>
                  <td align="left" valign="top" class="titulos_diplo"><?php echo '<span class="titulos_diplo">'.$row_programa['program_name'].'</span>';
                ...
                <tr>
                  <td valign="top"><p><?php echo $row_programa['description']; ?></p></td>
                </tr>
                <tr>
                  <td valign="top"><? if($row_programa['observaciones']!=NULL){echo '<p>'.$row_programa['observaciones'].'</p>';} ?></td>
                </tr>
                <tr>
                  <td valign="top"><?php while($row_fecha_ini = mysql_fetch_assoc($fecha_ini)){ ?>
                    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0">
                      <tr>
                        <td height="22" colspan="3" align="center" valign="middle"><span class="contenido_diploRojo"><strong><?php echo $row_fecha_ini['nivel']; ?></strong></span>&nbsp;<?php echo $row_fecha_ini['subnivel']; ?></td>
                      </tr>
                      <tr>
                        <td width="27%" align="right" valign="top" class="contenido_diploRojo">Inicio</td>
                        <td width="2%" rowspan="4" class="linea_separadora_g">&nbsp;</td>
                        <td width="70%" align="left" valign="top"><?php echo strftime("%d de %B de %Y", strtotime($row_fecha_ini['inicio'])); ?></td>
                      </tr>
                      <tr>
                        <td align="right" valign="top" class="contenido_diploRojo">Duraci&oacute;n</td>
                        <td align="left" valign="top"><?php echo $row_fecha_ini['duracion']; ?></td>
                      </tr>
                      <tr>
                        <td align="right" valign="top" class="contenido_diploRojo">Horario</td>
                        <td align="left" valign="top"><?php 
								if($row_fecha_ini['horario']!=NULL){echo $row_fecha_ini['horario'];}
								if($row_fecha_ini['horario2']!=NULL){echo '<br>'.$row_fecha_ini['horario2'];}
								if($row_fecha_ini['horario_mat']!=NULL){echo '<br>'.$row_fecha_ini['horario_mat'];}
								if($row_fecha_ini['horario_vesp']!=NULL){echo '<br>'.$row_fecha_ini['horario_vesp']; }
							?></td>
                      </tr>
                      <tr>
                        <td align="right" valign="top" class="contenido_diploRojo">Costo</td>
                        <td align="left" valign="top"><?php echo $row_fecha_ini['costo']; ?></td>
                      </tr>
                      <tr>
                  ...
                  <td><table width="100%" border="0" align="center" cellpadding="3" cellspacing="0">
					...
					if($totalRows_fecha_ini != 0){
						...
						while($row_fecha_ini = mysql_fetch_assoc($fecha_ini)){
							if($row_fecha_ini['id_sede'] != NULL){$sede_not_null=1; echo $sede_not_null;}
						}
					...
					?>
                      <tr>
                        <?php } ?>
                        <td width="27%" align="right" valign="top" class="contenido_diploRojo">Informes</td>
                        <td width="2%" rowspan="2" class="linea_separadora_g"></td>
                        <td width="70%"><p>
                            <?php
                      ...
                      <tr>
                        <td align="right"><a href="#" onclick="parent.location='http://www.diplomados.uia.mx/formulario_preinscripcion.php'"><img src= "imagenes/icono_insc.gif" width="30" height="30" border="0" /></a></td>
                ...
                <tr>
                  <td valign="top"><? if($row_programa['banner']!=NULL){echo '<img src="'.$row_programa['banner'].'" />';} ?></td>
                </tr>
              </table>
...
mysql_free_result($progs_cursos);
?>
