...
<link href="estilos_txt.css" rel="stylesheet" type="text/css" />
          ...
          <ul>
            ...
            <li><a href="#" onclick="parent.location='http://www.diplomados.uia.mx/articulos.php?id_discipline=12'">Preparatoria
              Abierta</a></li>
               ...
               <h4>Programas impartidos<br />por 
Harvard Graduate<br />School of 
...
<?php
	...
	$mensaje.="<b>Teléfono:</b> $telefono<br /><br />";
	...
	mail("erika.medina@uia.mx", "DEC - Contacto", $mensaje, $headers);
	//mail("pvazquezdiaz@gmail.com", "DEC - Contacto", $mensaje, $headers);
	//mail("jlaa2774@hotmail.com", "DEC - Contacto", $mensaje, $headers);
	
	//para mandar el mail en texto plano.
	//mail("jlaa2774@hotmail.com", "DEC - Forma de Contacto", $mensaje, "FROM:$email");

  $insertSQL = sprintf("INSERT INTO contact (name, email, telephone, coments) VALUES (%s, %s, %s, %s)",
...
<table width="94%" border="0" align="center" cellpadding="4" cellspacing="0">
  ...
  <tr>
    <td align="center"><p>Gracias por ponerse en contacto con nosotros.</p>
    	<p>&nbsp;</p>
    	<p><input type="button" onclick="window.location='http://www.dec-uia.com/otono_2011/contacto.php'" value="Regresar"></p></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
    </tr>
...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
<!-- Google AdWords Code for contacto Conversion Page -->
<script type="text/javascript">
/* <![CDATA[ */
var google_conversion_id = 1049020738;
var google_conversion_language = "es";
var google_conversion_format = "1";
var google_conversion_color = "ffffff";
var google_conversion_label = "rnzkCMKu2QEQwpKb9AM";
...
src="http://www.googleadservices.com/pagead/conversion/1049020738/?label=rnzkCMKu2QEQwpKb9AM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>

<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
<!-- Facebook -->
<!-- Pega este código encima de la etiqueta </body> de cierre de tu página de
conversión. Cada vez que se carga esta página, la etiqueta registra una conversión.
Los campos "sku" y "value" opcionales se describen en el Servicio de ayuda. -->
