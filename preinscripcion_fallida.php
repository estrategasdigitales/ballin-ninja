    ...
    <div id= "type4" class="rectangulo_abajo_secciones" style="border:0px">
      <div class="textos"><!-- InstanceBeginEditable name="contenido" -->
		<table width="94%" border="0" align="center" cellpadding="4" cellspacing="0">
		  ...
		  <tr>
			<td align="center">
			<p>Lo sentimos.</p><p>Ha ocurrido un error con tu pre registro.</p>
			  <p>Faavor de intearlo de nuevo. Si el problema persiste, contáctanos en el correo<br /><a href="mailto:webmaster@dec-uia.com">webmaster@dec-uia.com</a>.</p>
			  <p>&nbsp;</p>
