    ...
    <div id= "type4" class="rectangulo_abajo_secciones">
      <div class="textos"><!-- InstanceBeginEditable name="contenido" -->
		  	<table width="95%" border="0" align="center" cellpadding="10" cellspacing="0">
		  		<tr>
		  			<td width="71%" height="50" valign="bottom" class="contenido_diploBold">Formato
		  				de Preinscripci&oacute;n</td>
		  		...
		  		<tr>
		  			<td colspan="2" class="contenido_diplo">La direcci&oacute;n de educaci&oacute;n
		  				...
		  				de inscripci&oacute;n.</td>
	  			</tr>
		  		<tr>
		  			<td colspan="3">
					<table width="90%" border="0" align="left" cellpadding="2">
<tr>
<td width="90%" height="30" align="left" valign="middle" style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; color: #666;">Si
  deseas pedir informaci&oacute;n sobre alg&uacute;n curso o diplomado, haz click <a style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; color: #F00; text-decoration:none; cursor:pointer;" href="informes.php">aqu&iacute;</a></td>
</tr>
<tr>
  <td height="30" align="left" valign="middle" style="font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: #F00; text-decoration:none;"><strong>Preinscripci&oacute;n</strong></td>
  </tr>
</table>
...
<!--form id="form1" name="form1" method="post" onsubmit="return validate(this);" action="http://www.dec-uia.com/site/forma_preinscripcion_envia_mail_ss.php"-->
  <table width="100%" border="0" align="left" cellpadding="2" name="pre_table" id="pre_table">
    <tr>
      <td colspan="2" align="left"><span class="contenido_diplo"><strong>Nombre del Programa*</strong></span></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="2"><span class="contenido_diplo"><label>Programa:
          <br />
          <select class="contenido_diplo" name="nombre_programa" id="nombre_programa">
            <?php
			if($totalRows_diplos_names != 0){ ?>
            <option>---------------DIPLOMADOS---------------</option>
			<?php do { ?>
				<option value="<?php echo $row_diplos_names['id_program']?>"><?php echo $row_diplos_names['program_name']; ?></option>
						<?php
		...
		if($totalRows_diplos_names_2 != 0){
			...
			<?php do { 
				...
				for($i = 0; $i < sizeof($diplos_disc_alter_array); $i++){
					...
					<option value="<?php echo $row_diplos_names_2['id_program']?>"><?php echo $row_diplos_names_2['program_name']; ?></option>
							<?php
						}
					}
        ...
        <?php do { ?>
                    <option value="<?php echo $row_cursos_names['id_program']?>"><?php echo $row_cursos_names['program_name']; ?></option>
                    <?php
		...
		if($totalRows_cursos_names_2 != 0){
			do { 
				...
				for($i = 0; $i < sizeof($cursos_disc_alter_array); $i++){
                    ...
                    <option value="<?php echo $row_cursos_names_2['id_program']?>"><?php echo $row_cursos_names_2['program_name']; ?></option>
                    <?php
					}
				}
    ...
    <tr>
      <td width="30%" align="right"><span class="contenido_diplo">¿Cómo se enteró del programa? *</span></td>
      <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="50%"><span class="contenido_diplo">
            <label>
...
Recomendaci&oacute;n</label>
    ...
    <tr>
      <td height="50" colspan="2" align="center"><span class="contenido_diploBold">Informaci&oacute;n
      Personal</span></td>
    </tr>
    <tr>
      <td width="30%" align="right"><span class="contenido_diplo">A. Paterno *</span></td>
      <td><span class="contenido_diplo">
        <input name="a_paterno" type="text" id="a_paterno" size="30" />
      </span></td>
    </tr>
    <tr>
      <td width="30%" align="right"><span class="contenido_diplo">A. Materno *</span></td>
      <td><span class="contenido_diplo">
        <input name="a_materno" type="text" id="a_materno" size="30" />
      </span></td>
    </tr>
    <tr>
      <td width="30%" align="right"><span class="contenido_diplo">Nombre(s) *</span></td>
      <td><span class="contenido_diplo">
        <input name="nombre" type="text" id="nombre" size="30" />
      </span></td>
    </tr>
    <tr>
      <td width="30%" align="right"><span class="contenido_diplo">Domicilio *</span></td>
      <td><span class="contenido_diplo">
        <input name="domicilio" type="text" id="domicilio" size="30" />
      </span></td>
    </tr>
    <tr>
      <td width="30%" align="right"><span class="contenido_diplo"> Colonia *</span></td>
      <td><span class="contenido_diplo">
        <input name="colonia" type="text" id="colonia" size="30" />
      </span></td>
    </tr>
    <tr>
      <td width="30%" align="right"><span class="contenido_diplo">Del./ Mpo. / Poblaci&oacute;n
      *</span></td>
      <td><span class="contenido_diplo">
        <input name="del_mpo_pob" type="text" id="del_mpo_pob" size="30" />
      </span></td>
    </tr>
    <tr>
      <td width="30%" align="right"><span class="contenido_diplo">C.P. *</span></td>
      <td><span class="contenido_diplo">
        <input name="cp" type="text" id="cp" size="30" />
      </span></td>
    </tr>
    <tr>
      <td width="30%" align="right"><span class="contenido_diplo">Ciudad *</span></td>
      <td><span class="contenido_diplo">
        <input name="ciudad" type="text" id="ciudad" size="30" />
      </span></td>
    </tr>
    <tr>
      <td width="30%" align="right"><span class="contenido_diplo">Estado *</span></td>
      <td><span class="contenido_diplo">
        <input name="estado" type="text" id="estado" size="30" />
      </span></td>
    </tr>
    <tr>
      <td width="30%" align="right" valign="top"><span class="contenido_diplo">RFC personal *</span></td>
      <td><span class="contenido_diplo">
      ...
      <br />*Si cuentas con homoclave, favor de proporcionarla. Gracias.</span></td>
    </tr>
    <tr>
      <td width="30%" align="right"><span class="contenido_diplo">Tel. casa *</span></td>
      <td><span class="contenido_diplo">
        <input name="tel_casa" type="text" id="tel_casa" size="30" />
      </span></td>
    </tr>
    <tr>
      <td width="30%" align="right"><span class="contenido_diplo">Fax</span></td>
      <td><span class="contenido_diplo">
        <input name="fax" type="text" id="fax" size="30" />
      </span></td>
    </tr>
    <tr>
      <td width="30%" align="right"><span class="contenido_diplo">Celular</span></td>
      <td><span class="contenido_diplo">
        <input name="cel" type="text" id="cel" size="30" />
      </span></td>
    </tr>
    <tr>
      <td width="30%" align="right"><span class="contenido_diplo">E-Mail *</span></td>
      <td><span class="contenido_diplo">
        <input name="email" type="text" id="email" size="30" />
      </span></td>
    </tr>
    <tr>
      <td width="30%" align="right"><span class="contenido_diplo">Nacionalidad *</span></td>
      <td><span class="contenido_diplo">
        <input name="nacionalidad" type="text" id="nacionalidad" size="30" />
      </span></td>
    </tr>
    <tr>
      <td width="30%" align="right"><span class="contenido_diplo">Estado civil</span></td>
      <td><span class="contenido_diplo">
        <input name="edo_civil" type="text" id="edo_civil" size="30" />
      </span></td>
    </tr>
    <tr>
      <td height="50" colspan="2" align="center"><span class="contenido_diploBold">Informaci&oacute;n
    ...
    <tr>
      <td align="right" class="contenido_diplo"><span class="contenido_diplo">Nivel acad&eacute;mico
      *</span></td>
      <td><table width="100%">
        <tr>
          <td><span class="contenido_diplo">
...
Maestr&iacute;a</label>
    ...
    <tr>
      <td align="right"><span class="contenido_diplo">Instituci&oacute;n de estudios *</span></td>
      <td><span class="contenido_diplo">
        <input name="inst_estudios" type="text" id="inst_estudios" size="30" />
      </span></td>
    </tr>
    <tr>
      <td align="right"><span class="contenido_diplo">¿Porqué elegiste a la Ibero?</span></td>
      <td><span class="contenido_diplo">
        <textarea name="porque_elegiste_a_la_ibero" id="porque_elegiste_a_la_ibero" cols="30" rows="5"></textarea>
      </span></td>
    </tr>
    <tr>
      <td align="right"><span class="contenido_diplo">¿Ex alumno UIA? *</span></td>
      <td><table width="200">
        <tr>
          <td><span class="contenido_diplo">
            <label>
    ...
    <tr>
      <td align="right"><span class="contenido_diplo">Empresa</span></td>
      <td><span class="contenido_diplo">
        <input name="empresa" type="text" id="empresa" size="30" />
      </span></td>
    </tr>
    <tr>
      <td align="right"><span class="contenido_diplo">Depto.</span></td>
      <td><span class="contenido_diplo">
        <input name="empresa_depto" type="text" id="empresa_depto" size="30" />
      </span></td>
    </tr>
    <tr>
      <td align="right"><span class="contenido_diplo">Puesto</span></td>
      <td><span class="contenido_diplo">
        <input name="empresa_puesto" type="text" id="empresa_puesto" size="30" />
      </span></td>
    </tr>
    <tr>
      <td align="right"><span class="contenido_diplo">Direcci&oacute;n</span></td>
      <td><span class="contenido_diplo">
        <input name="empresa_direccion" type="text" id="empresa_direccion" size="30" />
      </span></td>
    </tr>
    <tr>
      <td align="right"><span class="contenido_diplo">Colonia</span></td>
      <td><span class="contenido_diplo">
        <input name="empresa_colonia" type="text" id="empresa_colonia" size="30" />
      </span></td>
    </tr>
    <tr>
      <td align="right"><span class="contenido_diplo">Del. / Mpo. / Poblaci&oacute;n</span></td>
      <td><span class="contenido_diplo">
        <input name="empresa_del_mpo_pob" type="text" id="empresa_del_mpo_pob" size="30" />
      </span></td>
    </tr>
    <tr>
      <td align="right"><span class="contenido_diplo">C.P.</span></td>
      <td><span class="contenido_diplo">
        <input name="empresa_cp" type="text" id="empresa_cp" size="30" />
      </span></td>
    </tr>
    <tr>
      <td align="right"><span class="contenido_diplo">Ciudad</span></td>
      <td><span class="contenido_diplo">
        <input name="empresa_ciudad" type="text" id="empresa_ciudad" size="30" />
      </span></td>
    </tr>
    <tr>
      <td align="right"><span class="contenido_diplo">Estado</span></td>
      <td><span class="contenido_diplo">
        <input name="empresa_estado" type="text" id="empresa_estado" size="30" />
      </span></td>
    </tr>
    <tr>
      <td align="right"><span class="contenido_diplo">Tel&eacute;fono</span></td>
      <td><span class="contenido_diplo">
        <input name="empresa_tel" type="text" id="empresa_tel" size="30" />
      </span></td>
    </tr>
    <tr>
      <td align="right"><span class="contenido_diplo">Fax</span></td>
      <td><span class="contenido_diplo">
        <input name="empresa_fax" type="text" id="empresa_fax" size="30" />
      </span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
