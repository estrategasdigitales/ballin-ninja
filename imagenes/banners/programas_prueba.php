          ...
          <tr>
            <td align="left" valign="top"><div id="menu_areas">
                ...
                <ul>
                  ...
                  <li><a href="#" onclick="parent.location='http://www.diplomados.uia.mx/c_religiosas.php?id_discipline=18'" <? if($_GET['id_discipline']==18){echo 'style="color: #333; background: #fff;"';}?>>Ciencias
                    Religiosas</a></li>
                ...
                <ul>
                  ...
                  <li><a href="#" onclick="parent.location='http://www.diplomados.uia.mx/programas.php?id_discipline=20&id_program=195'" <? if($_GET['id_discipline']==20){echo 'style="color: #333; background: #fff;"';}?>>Estudio Lofft</a></li>
            ...
            <td align="right" valign="top"><!-- InstanceBeginEditable name="programas" -->
              <div id="menu_programas">
                ...
                <ul class="lista_programas">
                  ...
                  <li><a href="#" onclick="parent.location='http://www.diplomados.uia.mx/programas.php?id_discipline=<? echo $_GET['id_discipline']; ?>&id_program=<? echo $row_progs_diplos_2['id_program']; ?>'">*<? echo $row_progs_diplos_2['program_name'];  ?>  <? if($row_progs_diplos['program_new']==1){echo '<span class="contenido_diploRojo"> Nuevo </span> ';}?> </a></li>
                ...
                <?php do { ?>
                    ...
                    <a href="#" onclick="parent.location='http://www.diplomados.uia.mx/idiomas.php?id_discipline=<? echo $_GET['id_discipline']; ?>&id_program=<? echo $row_progs_cursos['id_program']; ?>'"><? echo $row_progs_cursos['program_name']; if($row_progs_cursos['periodo']=='p'){echo ' <em>(Primavera)</em>';}else if($row_progs_cursos['periodo']=='v'){echo ' <em>(Verano)</em>';} if($row_progs_cursos['program_new']==1){echo ' <span class="avisos_mas">Nuevo</span>';}?></a>
                    <? } ?>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="130" class="fondoBanners"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="34%" align="center" valign="top"><a onclick="parent.location='http://www.diplomados.uia.mx/catalogo.php'" href="#"><img width="120" height="143" border="0" align="middle" src="imagenes/banners/oferta-educativa.png"></a></td>
                <td width="34%" align="center" valign="top"><img src="imagenes/banners/redes.png" width="123" height="142" border="0" align="left" usemap="#Map2" class="banner_bottom" /></a></td>
                <td width="32%" align="center" valign="top"><a href="#" onclick="parent.location='http://www.diplomados.uia.mx/promociones.php'"><img class="banner_bottom" src="imagenes/banners/promociones.png" width="116" height="139" border="0" align="top" /></a></td>
              </tr>
            </table></td>
        </tr>
      </table>
          ...
          <tr>
            <td><!-- InstanceBeginEditable name="contenido" -->
              ...
              <table width="100%" border="0" align="left" cellpadding="0" cellspacing="5">
                <tr>
                  <td width="80%"><?php echo '<h1>'.$row_programa['program_name'].'</h1>';
                ...
                <tr>
                  <td><? if($row_programa['description'] != NULL){ ?>
                    <h3>Rese&ntilde;a del Programa:</h3>
                    <? } ?>
                    <p><?php echo $row_programa['description']; ?> </p>
                    <h3>
                      <?php
                    ...
                    <p>
                      <?php if($row_maestro['titulo_maestro']!=NULL){echo $row_maestro['titulo_maestro'].'&nbsp;';} echo $row_maestro['nombre_maestro']?>
                      <br />
                      <?php
						if($row_maestro['telefono']!=NULL){echo 'Tel. '.$row_maestro['telefono'].' / ';}
						if($row_maestro['mail']!=NULL){echo '<a href="mailto:'.$row_maestro['mail'].'">'.$row_maestro['mail'].'</a>';} ?>
                    </p>
                    <?php if($row_maestro['cv'] != NULL){ ?>
                    <h3>Curr&iacute;culum del <?php echo $titulo; ?></h3>
                    ...
                    <?
					mysql_select_db($database_otono2011, $otono2011);
					$query_community_op = "SELECT id_opinion, short_name, degree, job_position FROM  community_opinions WHERE id_program = ".$_GET['id_program']." ORDER BY id_opinion DESC LIMIT 0, 1";
					...
					mysql_select_db($database_otono2011, $otono2011);
					$query_discipline_art = "SELECT id_article, id_discipline, interviewee_name, title FROM  discipline_articles WHERE id_program = ".$_GET['id_program']." AND type = 0 ORDER BY id_article DESC LIMIT 0, 1";
					...
					mysql_select_db($database_otono2011, $otono2011);
					$query_weekly_art = "SELECT id_article, interviewee_name, title FROM weekly_articles WHERE id_program = ".$_GET['id_program']." ORDER BY id_article DESC LIMIT 0, 1";
					...
					mysql_select_db($database_otono2011, $otono2011);
					$query_media_art = "SELECT id_article, id_program, title FROM media_articles WHERE id_program = ".$_GET['id_program']." ORDER BY id_article DESC LIMIT 0, 1";
					...
					if($total_interviews!=0){echo '<h3>Entrevistas:</h3>'; 
						if($totalRows_weekly_art!=0){?>
                    <p> <? echo '<a href="#" onclick="parent.location=\'http://www.diplomados.uia.mx/weekly_articles_detail.php?id_article='.$row_weekly_art['id_article'].'\'"><strong>'.$row_weekly_art['title'].'</strong>';
                    ...
                    <p> <? echo '<a href="#" onclick="parent.location=\'http://www.diplomados.uia.mx/articulos.php?id_discipline='.$row_discipline_art['id_discipline'].'&id_article='.$row_discipline_art['id_article'].'\'"><strong>'.$row_discipline_art['title'].'</strong> - '.$row_discipline_art['interviewee_name'];
							echo '</a>';?> </p>
                    <? }
						 if($totalRows_media_art!=0){ ?>
                    <p> <? echo '<a href="#" onclick="parent.location=\'http://www.diplomados.uia.mx/media_articles_detail.php?id_article='.$row_media_art['id_article'].'&source=media_articles\'"><strong>';
							echo $row_media_art['title'].'</strong>';
							echo '</a>';?> </p>
                    <? } 
						if($totalRows_community_op!=0){ ?>
                    <p> <? echo '<a href="#" onclick="parent.location=\'http://www.diplomados.uia.mx/community_opinions_detail.php?id_opinion='.$row_community_op['id_opinion'].'\'"><strong>La comunidad Ibero opina - </strong>'.$row_community_op['short_name'].'.';
                ...
                <tr>
                  <td colspan="2"><? if($row_programa['observaciones']!=NULL){echo '<p>'.$row_programa['observaciones'].'</p>';} ?></td>
                </tr>
                <tr>
                  <td colspan="2"><table width="100%" border="0" align="center" cellpadding="3" valign="top"  cellspacing="0">
                      <tr>
                        <?php if(($row_programa['program_colaboracion'] != NULL)&&($row_programa['program_colaboracion_img'] != NULL)){ ?>
                        <td width="29%" align="right" class="contenido_diploRojo">En colaboraci&oacute;n</td>
                      ...
                      <tr>
                        <td align="right" class="contenido_diploRojo">Inicio</td>
                        <?php if($row_programa['program_colaboracion'] == NULL || $row_programa['program_colaboracion_img'] == NULL){ ?>
					...
					if($row_programa['duration'] != NULL) {?>
                      <tr>
                        <td align="right" class="contenido_diploRojo">Duraci&oacute;n</td>
					...
					if($row_programa['costo_curso']!=NULL || $row_programa['cost_inscripcion']!=NULL || $row_programa['costo_modulo']!=NULL){?>
                      <tr>
                        <td align="right" class="contenido_diploRojo">Costo</td>
                        <td><?php 
					...
					if($row_fecha_ini['horario'] != NULL){ ?>
                      <tr>
                        <td align="right" class="contenido_diploRojo">Horario</td>
                        <td><?php
					...
					if($totalRows_fecha_ini != 0){
						...
						if($totalRows_fecha_ini != 0){
							...
							if($totalRows_fecha_ini > 0){?>
                      <tr>
                        <td align="right" class="contenido_diploRojo">Sede</td>
                        <td><?php
							do{
								$num_sedes++;
								echo '<p>';
                      ...
                      <tr>
                        <td align="right" class="contenido_diploRojo"><a href="temarios/<?php echo $row_programa['program_pdf']; ?>" target="_blank"> <img src="imagenes/icono_temario.gif" width="30" height="30" border="0" /></a></td>
                        <td><a href="temarios/<?php echo $row_programa['program_pdf']; ?>" target="_blank">Descargar Temario</a></td>
                      </tr>
                      <tr>
                        <?php } ?>
                        <td align="right" class="contenido_diploRojo"></td>
                ...
                <tr>
                  <td colspan="2"><? if($row_programa['banner']!=NULL){echo '<a href="'.$row_programa['banner_url'].'" target="_blank"><img src="imagenes/banners/programas_banners/'.$row_programa['banner'].'" /></a>';} ?></td>
                </tr>
              </table>
