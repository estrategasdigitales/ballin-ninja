...
//IDIOMAS
mysql_select_db($database_otono2011, $otono2011);
$query_progs_cursos_i = "SELECT * FROM site_programs WHERE program_type = 'curso' AND idioma = 1 AND cancelado = 0 AND id_discipline = ".$_GET['id_discipline']." AND id_program IN (SELECT id_program FROM site_fechas_idiomas WHERE fecha >= '2013-00-00' AND periodo = 'p') ORDER BY idioma ASC, program_name ASC";
      ...
      <div class="textos">
        <table width="100%" border="0" align="left" cellpadding="5" cellspacing="10">
      	...
      	<table width="100%" border="0" align="left" cellpadding="0" cellspacing="5">
      		<tr>
                <td><?php if($row_progs_diplos_3['program_new']==1){
									echo '<span class="contenido_diploRojo"> Nueva Versión </span> ';} ?>
                </td>
