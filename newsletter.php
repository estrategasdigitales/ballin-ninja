...
<title>Registro al newsletter</title>
<!-- InstanceEndEditable -->
    ...
    <div id= "type4" class="rectangulo_abajo_secciones">
      <div class="textos"><!-- InstanceBeginEditable name="contenido" -->
        <table width="95%" border="0" align="center" cellpadding="8" cellspacing="0">
          <tr>
            <td height="40" valign="bottom"><h1>Registro al newsletter</h1>
              <p>&nbsp;</p>
          <p>Suscr&iacute;bete y ent&eacute;rate de las novedades, promociones y
          programas de tu inter&eacute;s en la comodidad de tu email.</p>
...
<form action="http://www.dec-uia.com/cgi-bin/dada/mail.cgi" method="post" target="_blank" name="form_news" id="form_news">
								...
								<input name="email" type="text" id="email" value="" size="25" placeholder="email" />
								<input type="submit" value="Aceptar" class="processing" style="font-size:10px; background:#666; border-radius:5px; color:#FFF; width:50px; border:0px slid #FFF; width:50px;" /> </form>
        </p>
        
        <p><a href="politicas_privacidad.php" target="_blank" style="color:#FF0000;"><strong>He leido y acepto el Aviso de Privacidad</strong></a></p>
<p>&nbsp;</p>
        <p>Recibirás un correo de confirmación en tu bandeja de entrada.        </p></td>
          </tr>
        </table>
        <!-- InstanceEndEditable -->
