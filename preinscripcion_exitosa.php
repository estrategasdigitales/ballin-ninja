...
if($otro_medio != NULL) 
{
	$mensaje.="Otro_medio: ".$otro_medio."<br />";
}
		...
		<table width="94%" border="0" align="center" cellpadding="4" cellspacing="0">
		  ...
		  <tr>
			<td align="center"><p>Gracias, hemos recibido tu informaci&oacute;n
			  ...
			  <p>&nbsp;</p>
			  <p><input type="button" onclick="window.location='http://www.dec-uia.com/otono_2011/preinscripcion.php'" value="Regresar" /></p>
				
				<form action="http://www.dec-uia.com/cgi-bin/dada/mail.cgi" method="post" target="_blank" name="form_news_a" id="form_news_a">
