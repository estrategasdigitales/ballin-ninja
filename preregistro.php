...
function add_friend(){
	cont++;
	$('table#friends_table').append('<tr><td align="right" class="registro">Correo '+cont+':</td><td align="left"><input name="correo_'+cont+'" type="text" class="inputs" id="correo_'+cont+'" /></td></tr>');
...
<div id="container">
  ...
  <div id= "contenedor_irregular_index" >
    <div id= "type4" class="cuadro_articulos_secciones">
      <div style="position:relative; float:left; z-index:12;"> <!-- InstanceBeginEditable name="header" -->heaesdczxcr<!-- InstanceEndEditable --> </div>
      <div class="corner topLeft"></div>
      <div class="corner topRight"></div>
      <div class="corner bottomRight"></div>
    </div>
...
if($_GET['register'] == true){ 
	...
	<table width="400" border="0" align="center" cellpadding="5" cellspacing="0">
		...
		<tr>
			<td align="center" class="registro">Tu registro fue exitoso. Te notificaremos cuando la trivia sea liberada. Gracias.</p><p><a href="preregistro.php">Regresar</a></td>
		</tr>
	</table>
	';
}else{
?>
<form id="registro" name="registro" method="post" action="preregister.php" onsubmit="return check_form();">
	<table width="400" border="0" align="center" cellpadding="5" cellspacing="0">
		<tr>
			<td colspan="2" align="center" class="registro"><strong>Reg&iacute;strate ahora y s&eacute; de los primeros en jugar:</strong></td>
			</tr>
		<tr>
			<td align="right" class="registro">&nbsp;</td>
			<td width="235" align="left">&nbsp;</td>
		</tr>
		<tr>
			<td align="right" class="registro">Nombre: </td>
			<td width="235" align="left"><input name="nombre" type="text" class="inputs" id="nombre" /></td>
		</tr>
		<tr>
			<td width="145" align="right" class="registro">Apellidos:</td>
			<td align="left"><input name="apellido" type="text" class="inputs" id="apellido" /></td>
		</tr>
		<tr>
			<td align="right" class="registro">E-mail:
			<label for="correo"></label></td>
			<td align="left"><input name="email1" type="text" class="inputs" id="email1" /></td>
		</tr>
		<tr>
			<td align="right" class="registro">Contrase&ntilde;a:
			<label for="password"></label></td>
			<td align="left"><input name="password1" type="password" class="inputs" id="password1" /></td>
		</tr>
		<tr>
			<td align="right">&nbsp;</td>
			<td align="left"><? if($_GET['user'] == true){echo 'El correo proporcionado ya se encuentra registrado.';} ?></td>
		</tr>
	</table>
	<table width="400" border="0" align="center" cellpadding="5" cellspacing="0" id="friends_table">
		<tr>
			<td colspan="2" align="center" class="registro"><p><strong>Sugiere amigos y multiplica tu puntuaci&oacute;n</strong></p>
				<p>Cada amigo que sugieras y participe genera puntos extras en el juego</p></td>
		</tr>
		<tr>
			<td width="145" align="right" class="registro">Correo 1:</td>
			<td width="235" align="left"><input name="correo_1" type="text" class="inputs" id="correo_1" /></td>
		</tr>
		<tr>
			<td align="right" class="registro">Correo 2:</td>
			<td align="left"><input name="correo_2" type="text" class="inputs" id="correo_2" /></td>
		</tr>
		<tr>
			<td align="right" class="registro">Correo 3:</td>
			<td align="left"><input name="correo_3" type="text" class="inputs" id="correo_3" /></td>
		</tr>
	</table>
	
	<table width="400" border="0" align="center" cellpadding="5" cellspacing="0">
		<tr>
			<td align="center" class="registro"><input type="button" name="add_f" id="add_f" onclick="add_friend();" value="Agregar amigos" /></td>
		</tr>
		<tr>
			<td align="center" class="registro">&nbsp;</td>
		</tr>
		<tr>
			<td align="center" class="registro"><input type="submit" name="aceptar" id="aceptar" value="Pre-registrarse" style="background:#F00; border:none; color:#FFF; cursor:pointer;" /></td>
		</tr>
		<tr>
			<td align="center" class="registro">&nbsp;</td>
			</tr>
		<tr>
			<td align="center" class="registro"><span class="leyenda"><span style="color:#F00;">*</span><a href="bases.pdf" target="_blank">Descargar bases</a></span></td>
		</tr>
	</table>
	<input type="hidden" name="cont" id="cont" value="3" />
</form>
<? } ?>
