...
(SELECT id_preinscrito FROM sp_pasos_status WHERE sp_preinscritos.id_preinscrito = sp_pasos_status.id_preinscrito AND sp_pasos_status.pago_realizado = 1 AND sp_pasos_status.caso_cerrado = 0 AND sp_pasos_status.caso_inconcluso = 0 AND sp_pasos_status.informes = 0) ORDER BY fecha_registro DESC, id_preinscrito DESC";
...
(SELECT id_preinscrito FROM sp_pasos_status WHERE sp_preinscritos.id_preinscrito = sp_pasos_status.id_preinscrito AND sp_pasos_status.pago_realizado = 1 AND sp_pasos_status.caso_cerrado = 0 AND sp_pasos_status.caso_inconcluso = 0 AND sp_pasos_status.informes = 0) AND (";
...
if(isset($_GET['limpiar']) || $_GET['limpiar'] == "Quitar filtro"){
  echo '<script>window.location="inscritos.php";</script>';
}
...
<div class="sombra"> </div>
 ...
 <? }else{
	 echo '<p>NO HAY REGISTROS.</p><p>Recuerda que solamente se consideran inscritos aquellos que han sido registrados como "Pago realizado".</p>';
 } ?>
<div class="espacio"> </div>
<table width="100%" border="0">
	<tr>
