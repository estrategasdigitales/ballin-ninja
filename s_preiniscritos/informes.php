...
(SELECT id_preinscrito FROM sp_pasos_status WHERE sp_preinscritos.id_preinscrito = sp_pasos_status.id_preinscrito AND sp_pasos_status.pago_realizado = 0 AND sp_pasos_status.caso_cerrado = 0 AND sp_pasos_status.caso_inconcluso = 0 AND sp_pasos_status.informes = 1) ORDER BY fecha_registro DESC, id_preinscrito DESC";
...
(SELECT id_preinscrito FROM sp_pasos_status WHERE sp_preinscritos.id_preinscrito = sp_pasos_status.id_preinscrito AND sp_pasos_status.pago_realizado = 0 AND sp_pasos_status.caso_cerrado = 0 AND sp_pasos_status.caso_inconcluso = 0 AND sp_pasos_status.informes = 1) AND (";
...
<title>Sistema de Seguimiento - Informes</title>
<!-- InstanceEndEditable -->
...
<div class="sombra"> </div>
 ...
 <table width="960" border="0" cellpadding="5" cellspacing="0" class="tablas">
    <tr class="titulo_tabla">
      ...
      <td width="179">Programa de interés </td>
      <td width="79">Fecha</td>
	  <td width="299">Comentario</td>
	...
	do { 
		...
		<tr <? echo $bg; ?>>
			...
			<td align="left" class="celdas"><? if($row_paso['comentario_general'] != ''){echo utf8_encode($row_paso['comentario_general']);} ?></td>
			...
			<td align="center" valign="middle" class="celdas"><? if($row_paso['envio_claves'] == 1){echo '<img src="imagenes/green.png"/>';} if($comment_3 != ''){echo ' <a href="#" title="'.$comment_3.'" class="tooltip_a"><img src="imagenes/informacion.png"/></a>';} ?></td>
			<td align="center" valign="middle" class="celdas"><? if($row_paso['pago_realizado'] == 1){echo '<img src="imagenes/green.png"/>';} if($comment_4 != ''){echo ' <a href="#" title="'.$comment_4.'" class="tooltip_a"><img src="imagenes/informacion.png"/></a>';} ?></td-->
			<td align="center" valign="middle" class="celdas"><form method="post" action="preinscrito_eliminar.php" onsubmit="return confirmar();">
