...
<div style="margin:10px;">
  <form method="post" action="preinscrito_editar_a.php?id_preinscrito=<? echo $_GET['id_preinscrito']; ?>" name="form1" id="form1" enctype="multipart/form-data" <? if($row_paso['envio_decse'] == 0){echo 'onsubmit="return check_decse();"';} ?>>
        ...
        <td><h2>Estatus del proceso</h2>
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="11">&nbsp;</td>
              <td width="165"><p class="anadir_comentario"><a style="cursor:pointer;" onclick="add_small_comment('td_comment_primercontacto','<? echo $comment_1; ?>')"><img src="imagenes/comentario.png" /> a&ntilde;adir - editar comentario</p>
                </a></td>
            </tr>
            <tr>
