...
(SELECT id_preinscrito FROM sp_pasos_status WHERE sp_preinscritos.id_preinscrito = sp_pasos_status.id_preinscrito AND sp_pasos_status.pago_realizado = 0 AND sp_pasos_status.caso_cerrado = 1 AND sp_pasos_status.caso_inconcluso = 0 AND sp_pasos_status.informes = 0) ORDER BY fecha_registro DESC, id_preinscrito DESC";
...
(SELECT id_preinscrito FROM sp_pasos_status WHERE sp_preinscritos.id_preinscrito = sp_pasos_status.id_preinscrito AND sp_pasos_status.pago_realizado = 0 AND sp_pasos_status.caso_cerrado = 1 AND sp_pasos_status.caso_inconcluso = 0 AND sp_pasos_status.informes = 0) AND (";
...
if(isset($_GET['limpiar']) || $_GET['limpiar'] == "Quitar filtro"){
  echo '<script>window.location="casos_cerrados.php";</script>';
}
...
<title>Sistema de Seguimiento - Casos Cerrados</title>
<!-- InstanceEndEditable -->
