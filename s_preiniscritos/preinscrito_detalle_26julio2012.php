...
<table width="500" border="0" align="center" cellpadding="3" cellspacing="0">
	...
	<tr>
		<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td align="center"><input type="button" name="editar" id="editar" value="Editar información" <? if($row_paso['envio_decse'] == 1 && $row_paso['envio_claves'] == 0){echo 'disabled="disabled"';} ?> onclick="javascrip:window.location='preinscrito_editar.php?id_preinscrito=<? echo $_GET['id_preinscrito']; ?>&id_program=<? echo $row_preinscrito['id_program']; ?>'" /></td>
