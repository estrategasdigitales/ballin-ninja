...
$sql = "SELECT *, (select program_name from site_programs where sp_preinscritos.id_program = site_programs.id_program) AS Programa FROM sp_preinscritos WHERE codigo LIKE '%PSV-%' ORDER BY fecha_registro DESC";
...
header("Content-Disposition: attachment; filename=tabla_San_Valentin.xls");
echo $return; 
?>