...
(SELECT id_preinscrito FROM sp_pasos_status WHERE sp_preinscritos.id_preinscrito = sp_pasos_status.id_preinscrito AND sp_pasos_status.pago_realizado = 0 AND sp_pasos_status.caso_cerrado = 0 AND sp_pasos_status.caso_inconcluso = 0 AND sp_pasos_status.informes = 0 AND sp_pasos_status.envio_decse = 1 AND sp_pasos_status.envio_claves = 0) ORDER BY sp_preinscritos.fecha_envio_decse DESC";
