...
//$query_programas = "SELECT id_program, program_type, program_name FROM site_programs WHERE cancelado = 0 AND id_discipline_alterna = 20 AND id_program IN (SELECT id_program FROM site_fechas_ini WHERE periodo = 'p') ORDER BY program_type DESC, program_name ASC";
$query_programas = "SELECT id_program, program_type, program_name FROM site_programs WHERE  id_discipline = 20 OR id_discipline_alterna = 20 AND id_program IN (SELECT id_program FROM site_fechas_ini WHERE fecha >= '2013-01-01' AND periodo = 'p') ORDER BY program_type DESC, program_name ASC";
...
(SELECT id_preinscrito FROM sp_pasos_status WHERE sp_preinscritos.id_preinscrito = sp_pasos_status.id_preinscrito AND sp_pasos_status.pago_realizado = 0 AND sp_pasos_status.caso_cerrado = 0 AND sp_pasos_status.caso_inconcluso = 0 AND sp_pasos_status.informes = 0) ORDER BY fecha_registro DESC, id_preinscrito DESC";
	...
	$query_preinscritos = "SELECT * FROM sp_preinscritos WHERE id_discipline IN(SELECT id_discipline FROM site_programs WHERE id_discipline_alterna = 20) AND id_preinscrito IN
(SELECT id_preinscrito FROM sp_pasos_status WHERE sp_preinscritos.id_preinscrito = sp_pasos_status.id_preinscrito AND sp_pasos_status.pago_realizado = 0 AND sp_pasos_status.caso_cerrado = 0 AND sp_pasos_status.caso_inconcluso = 0 AND sp_pasos_status.informes = 0) ORDER BY fecha_registro DESC, id_preinscrito DESC";
...
<h3>
  ...
  if(isset($_GET['id_program']) && $_GET['id_program'] != 0){
	  ...
	  echo $row_prog_temp['program_type'].' en '.$row_prog_temp['program_name'];
  }else{
 ...
 <table width="960" border="0" cellpadding="5" cellspacing="0" class="tablas">
	...
	do { 
		...
		<tr <? echo $bg; ?>>
			<td align="left" valign="middle" class="celdas"><strong><? if($row_paso['comentario_general'] != ''){echo '<a href="#" title="'.$row_paso['comentario_general'].'" class="tooltip_a"><img src="imagenes/informacion.png"/></a> ';} ?><a class="group1" href="preinscrito_detalle.php?id_preinscrito=<?php echo $row_preinscritos['id_preinscrito']; ?>"><?php echo utf8_encode($row_preinscritos['a_paterno']) .' '. utf8_encode($row_preinscritos['a_materno']) .', '.utf8_encode($row_preinscritos['nombre']); ?></a></strong></td>
			...
			<td align="center" valign="middle" class="celdas"><? if($row_paso['primer_contacto'] == 1){echo '<img src="imagenes/green.png"/>';} if($comment_1 != ''){echo ' <a href="#" title="'.$comment_1.'" class="tooltip_a"><img src="imagenes/informacion.png"/></a>';} ?></td>
			<td align="center" valign="middle" class="celdas"><? if($row_paso['documentos'] == 1){echo '<img src="imagenes/green.png"/>';} if($comment_2 != ''){echo ' <a href="#" title="'.$comment_2.'" class="tooltip_a"><img src="imagenes/informacion.png"/></a>';} ?></td>
			<td align="center" valign="middle" class="celdas"><? if($row_paso['envio_decse'] == 1){echo '<img src="imagenes/green.png"/>';} if($comment_3 != ''){echo ' <a href="#" title="'.$comment_3.'" class="tooltip_a"><img src="imagenes/informacion.png"/></a>';} ?></td>
			<td align="center" valign="middle" class="celdas"><? if($row_paso['envio_claves'] == 1){echo '<img src="imagenes/green.png"/>';} if($comment_4 != ''){echo ' <a href="#" title="'.$comment_4.'" class="tooltip_a"><img src="imagenes/informacion.png"/></a>';} ?></td>
			<td align="center" valign="middle" class="celdas"><? if($row_paso['pago_realizado'] == 1){echo '<img src="imagenes/green.png"/>';} if($comment_5 != ''){echo ' <a href="#" title="'.$comment_5.'" class="tooltip_a"><img src="imagenes/informacion.png"/></a>';} ?></td>
