...
$query_preinscritos = "SELECT * FROM sp_preinscritos WHERE nombre LIKE '%".$_GET['qs']."%' OR a_paterno LIKE '%".$_GET['qs']."%' OR a_materno LIKE '%".$_GET['qs']."%' ORDER BY fecha_registro DESC, id_preinscrito DESC";
...
<head>
	...
	<title>Sistema de Seguimiento - Resultados de búsqueda</title>
	<!-- InstanceEndEditable -->
		...
		<div id="header">
			<div id="logos">
				...
				<div id="home_link">
					...
					<form action="preinscritos.php" method="get" name="form2" id="form2">
			...
			//--------
								...
								<tr <? echo $bg; ?>>
									...
									<td align="left" valign="middle" class="celdas"><?php echo $row_programa['program_type'].' - '.utf8_encode($row_programa['program_name']); ?></td>
									<td align="center" valign="middle" class="celdas"><? echo utf8_encode(strftime("%d.%B.%Y", strtotime($row_preinscritos['fecha_registro']))); ?></td>
									...
									<td align="center" valign="middle" class="celdas"><? if($row_paso['envio_claves'] == 1){echo '<img src="imagenes/green.png"/>';} if($comment_3 != ''){echo ' <a href="#" title="'.utf8_encode(ucfirst(strtolower($comment_3))).'" class="tooltip_a"><img src="imagenes/informacion.png"/></a>';} ?></td>
									<td align="center" valign="middle" class="celdas"><? if($row_paso['pago_realizado'] == 1){echo '<img src="imagenes/green.png"/>';} if($comment_4 != ''){echo ' <a href="#" title="'.utf8_encode(ucfirst(strtolower($comment_4))).'" class="tooltip_a"><img src="imagenes/informacion.png"/></a>';} ?></td>
