...
<title>Sistema de Seguimiento - Informes - Resultados de búsqueda</title>
<!-- InstanceEndEditable -->
...
<div id="container">
 ...
 <table width="960" border="0" cellpadding="5" cellspacing="0" class="tablas">
	...
	do { 
		...
		<tr <? echo $bg; ?>>
			<td align="left" valign="middle" class="celdas"><strong><? if($row_paso['comentario_general'] != ''){echo '<a href="#" title="'.$row_paso['comentario_general'].'" class="tooltip_a">||</a> ';} ?><a class="group1" href="preinscrito_detalle.php?id_preinscrito=<?php echo $row_preinscritos['id_preinscrito']; ?>"><?php echo $row_preinscritos['a_paterno'] .' '. $row_preinscritos['a_materno'] .', '. $row_preinscritos['nombre']; ?></a></strong></td>
