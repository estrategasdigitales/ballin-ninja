...
mysql_select_db($database_des_preinscritos, $des_preinscritos);
$query_program_name = "SELECT id_program, program_name, program_type FROM site_programs WHERE id_program IN (SELECT id_program FROM site_fechas_ini WHERE periodo = 'o') ORDER BY program_type DESC, program_name ASC";
...
<table width="500" border="0" align="center" cellpadding="3" cellspacing="0">
	...
	<tr>
		<td><strong>Nombre completo: </strong><br />
			<table>
				<tr>
					<td>
						A. Paterno:<input type="text" name="a_paterno" id="a_paterno" value="<?php echo $row_preinscrito['a_paterno']; ?>" />
					</td>
					<td>
						A. Materno:<input type="text" name="m_materno" id="a_materno" value="<?php echo $row_preinscrito['a_materno']; ?>" />
					</td>
					<td>
						Nombre:<input type="text" name="nombre" id="nombre" value="<?php echo $row_preinscrito['nombre']; ?>" />
					</td>
				</tr>
			</table>
		</td>
	...
	<tr>
		<td><strong>Direcci&oacute;n: </strong><br />
			...
			Calle y número: <input type="text" name="calle_numero" id="calle_numero" value="<?php echo $row_preinscrito['calle_numero']; ?>" /><br />
			Colonia: <input type="text" name="colonia" id="colonia" value="<?php echo $row_preinscrito['colonia']; ?>" /><br />
			Delegaci&oacute; o municipio:<input type="text" name="del_mpo" id="del_mpo" value="<?php echo $row_preinscrito['del_mpo']; ?>" /><br />
			C.P. <input type="text" name="cp" id="cp" value="<?php echo $row_preinscrito['cp']; ?>" /><br />
			Ciuada: <input type="text" name="ciudad" id="ciudad" value="<?php echo $row_preinscrito['ciudad']; ?>" /><br />
			Estado: <input type="text" name="estado" id="estado" value="<?php echo $row_preinscrito['estado']; ?>" />
		
		</td>
	</tr>
	<tr>
		<td><strong>Tel&eacute;fono:</strong><br />
			<input type="text" name="telefono" id="telefono" value="<?php echo $row_preinscrito['telefono']; ?>" />
		</td>
	</tr>
	<tr>
		<td><strong>Celular: </strong><br />
			<input type="text" name="celular" id="celular" value="<?php echo $row_preinscrito['celular']; ?>" />
		</td>
	</tr>
	<tr>
		<td><strong>RFC: </strong><br />
			<input type="text" name="rfc" id="rfc" value="<?php echo $row_preinscrito['rfc']; ?>" />
		</td>
	</tr>
	<tr>
		<td><strong>Correo electr&oacute;nico: </strong><br />
			<input type="text" name="correo" id="correo" value="<?php echo $row_preinscrito['correo']; ?>" />
		</td>
	</tr>
	<tr>
		<td><strong>Instituci&oacute;n de estudios: </strong><br />
			<input type="text" name="institucion_estudios" id="institucion_estudios" value="<?php echo $row_preinscrito['institucion_estudios']; ?>" />
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td><strong>¿Porqué la Ibero?:</strong><br />
			<input type="text" name="porque_la_ibero" id="porque_la_ibero" value="<?php echo $row_preinscrito['porque_la_ibero']; ?>" />
		</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	...
	<tr>
		<td><table width="100%" border="0" cellspacing="0" cellpadding="5">
			<tr>
				<td align="center"><input type="checkbox" name="primer_contacto" id="primer_contacto" value="1" <? if($_SESSION['loggedin_id_access'] == 4){echo 'disabled="disabled"';} ?> <? if($row_paso['primer_contacto'] == 1){echo 'checked="checked"';} ?> /></td>
				<td align="center"><input type="checkbox" name="documentos" id="documentos" value="1" <? if($_SESSION['loggedin_id_access'] == 4){echo 'disabled="disabled"';} ?> <? if($row_paso['documentos'] == 1){echo 'checked="checked"';} ?> /></td>
				<td align="center"><input type="checkbox" name="claves" id="claves" disabled="disabled" <? if($row_paso['envio_claves'] == 1){echo 'checked="checked"';} ?> />
					<input type="hidden" name="envio_claves" id="envio_claves" value="<? echo $row_paso['envio_claves']; ?>" /></td>
				<td align="center"><input type="checkbox" name="pago_realizado" id="pago_realizado" value="1" <? if($row_paso['envio_claves'] == 0){echo 'disabled="disabled"';} ?> <? if($row_paso['pago_realizado'] == 1){echo 'checked="checked"';} ?> onchange="check_pago(1)" /></td>
			</tr>
			<tr>
	...
	<tr>
		<td><table width="100%" border="0" cellspacing="0" cellpadding="5">
			<tr>
				<td align="center"><? if($row_paso['envio_decse'] == 1){ ?>
					...
					<? } ?></td>
				<td align="center"><input type="checkbox" onchange="uncheck_other(this.id);" class="estatus" name="caso_cerrado" id="caso_cerrado" value="1" <? if($row_paso['pago_realizado'] == 1){echo 'disabled="disabled"';} ?> <? if($row_paso['caso_cerrado'] == 1){echo 'checked="checked"';} ?> /></td>
				<td align="center"><input type="checkbox" onchange="uncheck_other(this.id);" class="estatus" name="caso_inconcluso" id="caso_inconcluso" value="1" <? if($row_paso['pago_realizado'] == 1){echo 'disabled="disabled"';} ?> <? if($row_paso['caso_inconcluso'] == 1){echo 'checked="checked"';} ?> /></td>
				<td align="center"><input type="checkbox" onchange="uncheck_other(this.id);" class="estatus" name="informes" id="informes" value="1" <? if($row_paso['pago_realizado'] == 1){echo 'disabled="disabled"';} ?> <? if($row_paso['informes'] == 1){echo 'checked="checked"';} ?> /></td>
				</tr>
			<tr>
	...
	<tr>
		<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td align="center"><input type="button" name="cancelar" id="cancelar" value="Cancelar" onclick="javascrip:window.location='preinscrito_detalle.php?id_preinscrito=<? echo $_GET['id_preinscrito']; ?>'" /></td>
				<td align="center"><input type="submit" name="guardar" id="guardar" value="Guardar informaci&oacute;n" /></td>
				</tr>
			</table></td>
	</tr>
</table>
