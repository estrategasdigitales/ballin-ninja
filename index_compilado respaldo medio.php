...
<div id="espacio" style="width:5%;float:left"> 
  ...
  <div id= "contenedor_irregular_index">
    ...
    <div style="margin-left:29px">
    	      <div class="textos" style="margin-left:0px;top:0px;height:295px;width:1500px;background-image: url(imagenes/carrusel.png); background-repeat:no-repeat; background-position:left center;margin-bottom:9px;float:left">
		<div class="html_carousel" style="float:left;margin-left:0px;">
			<div id="foo5" class="foo5">
       			<div class="slide" id="parrafo1">
					<img src="http://www.dec-uia.com/otono_2011/imagenes/carrusel/1.jpg" alt="carousel 2" width="576" height="278" />
					<div>
				<h4>La Ibero y Hewlett-Packard, más de 10 años sumando esfuerzos</h4>
				<p>En este periodo ofertamos seis programas en el área de Tecnología.</p>
			</div>
		</div>
		       <div class="slide">
					<img src="http://www.dec-uia.com/otono_2011/imagenes/carrusel/2.jpg" alt="carousel 2" width="576" height="278" />
					<div>
				<h4>Infinity</h4>
				...
				<div class="slide">
					<img src="http://www.dec-uia.com/otono_2011/imagenes/carrusel/3.jpg" alt="carousel 3" width="576" height="278" />
					<div>
				<h4>Infinity</h4>
				<p>A concept that in many fields refers to a quantity without bound or end.</p>
			</div>
				...
				<div class="slide">
					<img src="http://www.dec-uia.com/otono_2011/imagenes/carrusel/4.jpg" alt="carousel 4" width="576" height="278" />
					<div>
				<h4>Infinity</h4>
				<p>A concept that in many fields refers to a quantity without bound or end.</p>
			</div>
...
<div style="width:172px;height:280px;float:left;align=center;margin-left:15px">
				<p id="parrafo1" align="center"><br> Tenemos motivos para celebrar: clausura otoño 2012 </p>
				<hr id="linea1">
				<p id="parrafo2" align="center">Gracias a nuestros alumnos por su empeño y dedicación<br></p>
					<div class="pagination" id="foo5_pag" style="width:182px;float:left;margin-top:16px"></div>
			</div>
