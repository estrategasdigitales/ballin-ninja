		  		...
		  		<tr>
					...
					<form method="post" action="propuestas_enviar.php" name="form" id="form" onsubmit="return check_form();">
						<table width="100%" border="0" cellspacing="0" cellpadding="5">
							...
							<tr>
								<td><strong>&iquest;Quieres recibir informaci&oacute;n?</strong></td>
							</tr>
							<tr>
								<td>Ingresa tus datos de contacto y tedaremos feedback de tu sugerencia.</td>
							</tr>
							<tr>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td><table width="282" border="0" cellspacing="0" cellpadding="5">
									<tr>
