          ...
          <tr>
            ...
            <td align="right" valign="top"><!-- InstanceBeginEditable name="programas" -->
              <table width="190" border="0" align="right" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="27" align="center" valign="middle" class="header_programas"><br />
                    Diplomados</td>
                </tr>
                <!--EMPIEZAN DIPLOS-->
                <?php do { ?>
                  <tr>
                    <td align="left" bgcolor="#FFFFFF" class="lista_programas"><a href="#" onclick="parent.location='http://www.diplomados.uia.mx/programas.php?id_discipline=<?php echo $_GET['id_discipline']; ?>&amp;id_program=<?php echo $row_progs_diplos['id_program']; ?>'"><?php echo $row_progs_diplos['program_name']; if($row_progs_diplos['periodo']=='p'){echo ' <em>(Primavera)</em>';}else if($row_progs_diplos['periodo']=='v'){echo ' <em>(Verano)</em>';} if($row_progs_diplos['program_new']==1){echo ' <br /><span class="avisos_mas">Nuevo</span>';}?></a></td>
                  </tr>
                  ...
                  <tr>
                    <td align="left" bgcolor="#FFFFFF" class="lista_programas"><a href="#" onclick="parent.location='http://www.diplomados.uia.mx/programas.php?id_discipline=<? echo $_GET['id_discipline']; ?>&id_program=<? echo $row_progs_diplos_2['id_program']; ?>'">*<? echo $row_progs_diplos_2['program_name']; if($row_progs_diplos_2['periodo']=='p'){echo ' <em>(Primavera)</em>';}else if($row_progs_diplos_2['periodo']=='v'){echo ' <em>(Verano)</em>';} if($row_progs_diplos_2['program_new']==1){echo ' <br /><span class="avisos_mas">Nuevo</span>';}?></a></td>
                  </tr>
                  <?php }
								}
                ...
                <!--TERMINAN DIPLOS--> 
                <!--EMPIEZAN CURSOS-->
                <?php if($totalRows_progs_cursos != 0 || $totalRows_progs_cursos_2 != 0){?>
                <tr bgcolor="#FFFFFF">
                  <td height="35" align="center" valign="middle" bgcolor="#FFFFFF" class="header_programas"><br />
                    Cursos</td>
                </tr>
                <?php do { ?>
                  <tr>
                    <td align="left" bgcolor="#FFFFFF" class="lista_programas"><?php if($row_progs_cursos['idioma'] == NULL){ ?>
                      <a href="#" onclick="parent.location='http://www.diplomados.uia.mx/programas.php?id_discipline=<? echo $_GET['id_discipline']; ?>&id_program=<? echo $row_progs_cursos['id_program']; ?>'"><? echo $row_progs_cursos['program_name']; if($row_progs_cursos['periodo']=='p'){echo ' <em>(Primavera)</em>';}else if($row_progs_cursos['periodo']=='v'){echo ' <em>(Verano)</em>';} if($row_progs_cursos['program_new']==1){echo ' <br /><span class="avisos_mas">Nuevo</span>';}?></a>
                  ...
                  <tr>
                    <td align="left" bgcolor="#FFFFFF" class="lista_programas"><a href="#" onclick="parent.location='http://www.diplomados.uia.mx/programas.php?id_discipline=<? echo $_GET['id_discipline']; ?>&id_program=<? echo $row_progs_cursos_2['id_program']; ?>'">*<? echo $row_progs_cursos_2['program_name']; if($row_progs_cursos_2['periodo']=='p'){echo ' <em>(Primavera)</em>';}else if($row_progs_cursos_2['periodo']=='v'){echo ' <em>(Verano)</em>';} if($row_progs_cursos_2['program_new']==1){echo ' <br /><span class="avisos_mas">Nuevo</span>';}?></a></td>
                  </tr>
                  <?php }
								}
							} while ($row_progs_cursos_2 = mysql_fetch_assoc($progs_cursos_2)); ?>
                <tr>
                  <td class="footer_programas">&nbsp;</td>
                </tr>
              </table>
              <!-- InstanceEndEditable -->
  ...
  <div id= "contenedor_irregular" >
    ...
    <div id= "type4" class="rectangulo_abajo">
      <div class="textos"><!-- InstanceBeginEditable name="contenido" -->
        <table width="93%" border="0" align="center" cellpadding="5" cellspacing="5">
          <tr>
