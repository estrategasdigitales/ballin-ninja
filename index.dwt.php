...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-20808724-1']);
...
<div id="container">
  ...
  <div id= "contenedor_irregular_index" >
    <div class="bannersuperior"><!-- TemplateBeginEditable name="weekly_articles" -->weekly_articles<!-- TemplateEndEditable --> 
    ...
    <div id= "type4" class="rectangulo_abajo_index">
      <div class="textos">
        <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
          <tr>
            <td><!-- TemplateBeginEditable name="contenido" -->contenido<!-- TemplateEndEditable --></td>
          </tr>
          <tr>
