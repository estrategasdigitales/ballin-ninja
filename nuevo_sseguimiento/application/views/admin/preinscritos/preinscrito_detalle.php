...
<div>																														
	<div><label>Programa:</label> <?php echo $preinscrito->program_name; ?></div>		
...
<div id="estatus_proceso">										
	...
	<div></label><input type="checkbox" name="primer_contacto" id="primer_contacto"><label>Primer contacto</label></div>
	...
	<div id="estatus_primer_contacto" style="display:none;"><textarea style="width:500" name="comentarios_primer_contacto"></textarea></div>											
																		
	<div><input type="checkbox" name="documentos"  id="documentos" <?php echo ($preinscrito->documentos==1)?"checked":""; ?> ><label>Documento</label></div>			
	...
	<div id="estatus_documentos" style="display:none;"><textarea style="width:500" name="comentarios_documentos"></textarea></div>																						
													
	<div><input type="checkbox" name="envio_decse" id="envio_decse" <?php echo ($preinscrito->envio_decse==1)?"checked":""; ?> ><label>Enviar a DECSE</label></div>			
	...
	<div id="estatus_envio_decse" style="display:none;"><textarea style="width:500" name="comentarios_envio_decse"></textarea></div>
	
	<div><input type="checkbox" name="envio_claves"  id="envio_claves" <?php echo ($preinscrito->envio_claves==1)?"checked":""; ?> ><label>Envío de claves</label></div>			
	...
	<div id="estatus_envio_claves" style="display:none;"><textarea style="width:500" name="comentarios_envio_claves"></textarea></div>
																									
	<div><input type="checkbox" name="pago_realizado"  id="pago_realizado" <?php echo ($preinscrito->pago_realizado==1)?"checked":""; ?> ><label>Pago realizado</label></div>			
	...
	<div id="estatus_pago_realizado" style="display:none;"><textarea style="width:500" name="comentarios_pago_realizado"></textarea></div>
</div>																																																																	
<div id="subir_documentos">	
	...
	?>																				
			<div><a href="<?php echo base_url('includes/admin/documentos/'.$documento->archivo); ?>" target="_blank"><?php echo $documento->doc_type; ?></a></div>			
	<?php 								
			}																							
		 } 
	?>																																																																		
...
<div id="clasificar_aspirante">																		
		<div><input type="checkbox" name="caso_cerrado"  id="caso_cerrado" <?php echo ($preinscrito->caso_cerrado==1)?"checked":""; ?>><label>Caso cerrado</label></div>										 
		<div><input type="checkbox" name="caso_inconcluso"  id="caso_inconcluso" <?php echo ($preinscrito->caso_inconcluso==1)?"checked":""; ?>><label>Caso inconcluso</label></div>										 
		<div><input type="checkbox" name="informes"  id="informes" <?php echo ($preinscrito->informes==1)?"checked":""; ?>><label>Informes</label></div>										 
		<div><input type="checkbox" name="atendido"  id="atendido" <?php echo ($preinscrito->atendido==1)?"checked":""; ?>><label>Atendido</label></div>										 
</div>														
<div id="comentarios">																																			
