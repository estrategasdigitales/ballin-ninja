<div id="add_edit_user">
	...
	<div class="cont_left">																													
	<div><label>Nombre: *</label><input type="text" name="nombre" value="<?php echo set_value('nombre'); ?>"></div>		
	<div><label>Apellido Paterno: *</label><input type="text" name="a_paterno" value="<?php echo set_value('a_paterno'); ?>"></div>			
	<div><label>Apellido Materno: </label><input type="text" name="a_materno" value="<?php echo set_value('a_materno'); ?>"></div>							
	<div><label>Descripción del puesto o rol que funge esta persona: *</label><textarea name="descripcion"><?php echo set_value('descripcion'); ?></textarea></div>			
	</div>																												
	...
	<select name="tipo" id="tipo">																										
		...
		<?php } ?>																																														
	<select/></div>																																																																						
	<div><label>Username: *</label><input type="text" name="username" value="<?php echo set_value('username'); ?>"></div>							
	<div><label>Password: *</label><input type="password" name="pass"></div>										
	<div><label>Confirmar Password:</label><input type="password" name="repass"></div>												
	<div><label>Correo electronico principal: *</label><input type="text" name="email_1" value="<?php echo set_value('email_1'); ?>"></div>		
	<div><label>Correo electronico secundario:</label><input type="text" name="email_2"  value="<?php echo set_value('email_2'); ?>"></div>						
	</div>																														
	<div class="clear"></div>										
