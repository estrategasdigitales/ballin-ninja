    ...
    b.extend(b.jgrid, {
        ...
        cellWidth: function () {
            var f = b("<div class='ui-jqgrid' style='left:10000px'><table class='ui-jqgrid-btable' style='width:5px;'><tr class='jqgrow'><td style='width:5px;'></td></tr></table></div>"),
                e = f.appendTo("body").find("td").width();
            f.remove();
            return 5 !== e
        },
        cell_width: !0,
        ...
        from: function (f) {
            return new function (e, c) {
                ...
                var d = this,
                    ...
                    v = !0;
                if ("object" === typeof e &&
                    e.push) 0 < e.length && (v = "object" !== typeof e[0] ? !1 : !0);
                ...
                this.startsWith = function (a, c) {
                    var e = null == c ? a : c,
                        e = f ? b.trim(e.toString()).length : e.toString().length;
            ...
            if (!this.grid) {
                var d = b.extend(!0, {
                    ...
                    c = {
                        ...
                        dragMove: function (a) {
                            if (this.resizing) {
                                var b = a.clientX - this.resizing.startX,
                                    ...
                                    c = "ltr" === d.direction ? a.width + b : a.width - b,
                                    e;
                        ...
                        selectionPreserver: function (a) {
                            var c = a.p,
                                e = c.selrow,
                                d = c.selarrrow ? b.makeArray(c.selarrrow) : null,
                                ...
                                h = function () {
                                    ...
                                    if (c.multiselect && d && 0 < d.length)
                                        for (g = 0; g < d.length; g++) d[g] != e && b(a).jqGrid("setSelection", d[g], !1, null);
                ...
                if ("TABLE" != this.tagName.toUpperCase()) alert("Element is not a table");
                    ...
                    if (0 === this.p.colNames.length)
                        for (e = 0; e < this.p.colModel.length; e++) this.p.colNames[e] = this.p.colModel[e].label ||
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                        ...
                        var s = function (a, b) {
                            ...
                            return isNaN(a) ? b || 0 : a
                                ...
                                if (d === 0) z = z + ("width: " + c.headers[e].width + "px;");
                                else if (k.cellattr && b.isFunction(k.cellattr))
                                    if ((e = k.cellattr.call(a, g, f, h, k, j)) && typeof e === "string") {
                                ...
                                var i = "-1",
                                    ...
                                    k, e = e ? "display:none;" :
                                        "",
                                    d = "ui-widget-content jqgrow ui-row-" + a.p.direction + d + (h ? " ui-state-highlight" : ""),
                                ...
                                if (b.isXMLDoc(c)) {
                                    ...
                                    var F = b(a),
                                        q, o, m = 0,
                                        r, D = a.p.multiselect === true ? 1 : 0,
                                        n = 0,
                                        s, l = a.p.rownumbers === true ? 1 : 0,
                                        v, p = [],
                                        y, B = {}, t, w, G = [],
                                ...
                                if (c) {
                                    ...
                                    var k = b(a),
                                        m = 0,
                                        q, o, n = [],
                                        r, D = a.p.multiselect ? 1 :
                                            0,
                                        l = 0,
                                        s, v = a.p.rownumbers === true ? 1 : 0,
                                        p, u, y = {}, B, t, w = [],
                                    ...
                                    var A = parseInt(a.p.rowNum, 10),
                                        C = a.p.scroll ? b.jgrid.randId() : 1,
                                        E = false,
                                        H;
                                    g && (A = A * (g + 1));
                                    a.p.datatype === "local" && !a.p.deselectAfterSort && (E = true);
                                    var L = b.isFunction(a.p.afterInsertRow),
                                        J = [],
                                        M = false,
                                        N;
                                    if (a.p.grouping) {
                                ...
                                if (b.isArray(a.p.data)) {
                                    var m = a.p.grouping ? a.p.groupingView : false,
                                        q, o;
                                    b.each(a.p.colModel, function () {
                                        ...
                                        if (j == "date" || j == "datetime") {
                                            ...
                                            o = 0;
                                            for (q = m.groupField.length; o < q; o++)
                                                if (this.name == m.groupField[o]) {
                                                    var c = this.name;
                                    ...
                                    if (a.p.treeGrid) b(a).jqGrid("SortTree", e, a.p.sortorder, f[e].stype, f[e].srcfmt);
                                    else {
                                        var n = {
                                            eq: function (a) {
                                                return a.equals
                                        ...
                                        if (a.p.grouping)
                                            for (o = 0; o < q; o++) r.orderBy(h[o], m.groupOrder[o], g[o].stype,
                                                g[o].srcfmt);
                                        ...
                                        var l = r.select(),
                                            ...
                                            s = l.length,
                                            u = parseInt(a.p.page, 10),
                                            x = Math.ceil(s / p),
                                            y = {}, l = l.slice((u - 1) * p, u * p),
                                            f = r = null;
                                ...
                                if (!a.grid.hDiv.loading) {
                                    ...
                                    var l = !a.p.scroll ? 1 : a.rows.length - 1,
                                            ...
                                            case "script":
                                                b.ajax(b.extend({
                                                        ...
                                                        success: function (d, g, h) {
                                                            if (b.isFunction(a.p.beforeProcessing) && a.p.beforeProcessing.call(a, d, g, h) === false) S();
                                                            else {
                                                                f === "xml" ?
                        ...
                        a.p.scroll && (a.p.pgbuttons = !1, a.p.pginput = !1,
                            a.p.rowList = []);
                        a.p.data.length && N();
                        var C = "<thead><tr class='ui-jqgrid-labels' role='rowheader'>",
                            ma, J, ea, ba, fa, A, p, T;
                        J = T = "";
                        ...
                        (function () {
                            var d = 0,
                                e = b.jgrid.cell_width ? 0 : s(a.p.cellLayout, 0),
                                f = 0,
                                g, h = s(a.p.scrollOffset, 0),
                                j, k = false,
                                m, l = 0,
                                n = 0,
                                q;
                        ...
                        var Y = null,
                            j = b("<table class='ui-jqgrid-htable' style='width:" + /*a.p.tblwidth*/ 970 + "px' role='grid' aria-labelledby='gbox_" + this.id + "' cellspacing='0' cellpadding='0' border='0'></table>").append(C),
                        ...
                        a.p.pager && ("string" === typeof a.p.pager ? "#" != a.p.pager.substr(0, 1) && (a.p.pager = "#" + a.p.pager) : a.p.pager = "#" + b(a.p.pager).attr("id"), b(a.p.pager).css({
                                width: c.width + "px"
                            }).appendTo(n).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom"),
                        ...
                        b(a).before(c.hDiv).click(function (c) {
                            ...
                            if (!(A.tagName == "A" || (A.tagName == "INPUT" || A.tagName == "TEXTAREA" || A.tagName == "OPTION" || A.tagName == "SELECT") && !d) && e === true) {
                                ...
                                if (a.p.cellEdit === true)
                                    if (a.p.multiselect && d) b(a).jqGrid("setSelection", u, true, c);
                                    else {
                                        u = p[0].rowIndex;
                                        try {
                                    ...
                                    if (c[a.p.multikey]) b(a).jqGrid("setSelection", u, true, c);
                                    else {
    ...
    b.jgrid.extend({
        ...
        getDataIDs: function () {
            ...
            this.each(function () {
                if ((c = this.rows.length) && 0 < c)
                    for (; e < c;) b(this.rows[e]).hasClass("jqgrow") &&
        ...
        getRowData: function (f) {
            ...
            this.each(function () {
                var h = this,
                    g, j;
                if (void 0 === f) d = !0, c = [], a = h.rows.length;
                else {
                ...
                for (; i < a;) d && (j = h.rows[i]), b(j).hasClass("jqgrow") && (b('td[role="gridcell"]', j).each(function (a) {
                    ...
                    if ("cb" !== g && "subgrid" !== g && "rn" !== g)
                        if (!0 === h.p.treeGrid && g == h.p.ExpandColumn) e[g] = b.jgrid.htmlDecode(b("span:first", this).html());
                        else try {
            ...
            this.each(function () {
                ...
                if (e) try {
                    if (b(this.p.colModel).each(function (a) {
                        d = this.name;
                        void 0 !== e[d] && (m[d] = this.formatter && "string" === typeof this.formatter && "date" == this.formatter ? b.unformat.date.call(h, e[d], this) : e[d], g = h.formatter(f, e[d], a, e, "edit"), i = this.title ? {
                            title: b.jgrid.stripHtml(g)
                        } : {}, !0 === h.p.treeGrid && d == h.p.ExpandColumn ? b("td[role='gridcell']:eq(" + a + ") > span:first", j).html(g).attr(i) : b("td[role='gridcell']:eq(" + a + ")", j).html(g).attr(i))
                    }), "local" == h.p.datatype) {
                        var n = b.jgrid.stripPref(h.p.idPrefix, f),
                            s = h.p._index[n],
                            l;
                        if (h.p.treeGrid)
                            for (l in h.p.treeReader) h.p.treeReader.hasOwnProperty(l) &&
                                delete m[h.p.treeReader[l]];
        ...
        footerData: function (f, e, c) {
            ...
            this.each(function () {
                ...
                b(this.p.colModel).each(function (d) {
                    a = this.name;
                    "set" == f ? void 0 !== e[a] && (k = c ? j.formatter("", e[a], d, e, "edit") : e[a], g = this.title ? {
                            title: b.jgrid.stripHtml(k)
                        } : {}, b("tr.footrow td:eq(" + d + ")", j.grid.sDiv).html(k).attr(g),
            ...
            return this.each(function () {
                ...
                if (this.grid && (isNaN(e) ? b(this.p.colModel).each(function (a) {
                    ...
                    if ("" !== c || !0 === i) g = this.formatter(f, c, h, g, "edit"), j = this.p.colModel[h].title ? {
                        title: b.jgrid.stripHtml(g)
                    } : {}, this.p.treeGrid && 0 < b(".tree-wrap", b(k)).length ? b("span", b(k)).html(g).attr(j) : b(k).html(g).attr(j), "local" == this.p.datatype && (g = this.p.colModel[h], c = g.formatter && "string" === typeof g.formatter && "date" == g.formatter ? b.unformat.date.call(this,
        ...
        bindKeys: function (f) {
            ...
            return this.each(function () {
                ...
                b(c).keydown(function (d) {
                    ...
                    if (a)
                        if (g = c.p._index[a.id], 37 === d.keyCode || 38 === d.keyCode || 39 === d.keyCode || 40 === d.keyCode) {
                            if (38 === d.keyCode) {
                                h = a.previousSibling;
                                f = "";
                                if (h)
...
(function (a) {
        ...
        if (d) {
            ...
            if (a.fmatter.isString(d)) {
                ...
                for (l = 0; l < j.length; l++)
                    if (h = j[l].split(f), 2 < h.length && (h[1] = a.map(h, function (a, b) {
                        if (b > 0) return a
    ...
    a.unformat = function (c, b, d, e) {
        var f, h = b.colModel.formatter,
            g = b.colModel.formatoptions || {}, i = /([\.\*\_\'\(\)\{\}\+\?\\])/g,
        ...
        if (e.value) {
            ...
            if (a.fmatter.isString(h)) {
                ...
                for (k = 0; k < i.length; k++)
                    if (f = i[k].split(b), 2 < f.length && (f[1] = a.map(f, function (a, b) {
                        if (b > 0) return a
    ...
    a.jgrid.extend({
            ...
            return this.each(function () {
                ...
                if (!this.ftoolbar) {
                            ...
                            if (l = this.surl || h.dataUrl) a.ajax(a.extend({
                                ...
                                if (k) {
                                    ...
                                    if ("string" === typeof k) {
                                        ...
                                        for (n in k) k.hasOwnProperty(n) && (i = document.createElement("option"),
                    ...
                    this.toggleToolbar = function () {
                        var b =
                            a("tr.ui-search-toolbar", c.grid.hDiv),
        ...
        setGroupHeaders: function (b) {
            ...
            return this.each(function () {
                ...
                for (c = 0; c < k; c++)
                    if (j = p[c].el, m = a(j), d = l[c], e = {
                            height: "0px",
                            width: p[c].width + "px",
                            display: d.hidden ? "none" : ""
                        }, a("<th>", {
                            role: "gridcell"
                        }).css(e).addClass("ui-first-th-" + this.p.direction).appendTo(o), j.style.width =
                        ...
                        if (0 <=
                            ...
                            a(b).bind("jqGridOnSortCol.setFrozenColumns", function (c, d) {
                                var e = a("tr.ui-jqgrid-labels:last th:eq(" + b.p.lastsort + ")", b.grid.fhDiv),
                                    f = a("tr.ui-jqgrid-labels:last th:eq(" +
                                        d + ")", b.grid.fhDiv);
        ...
        createEl: function (d, b, c, e, g) {
            ...
            case "select":
                ...
                if (void 0 !== b.dataUrl) d = b.name ? ("" +
                    ...
                    var n,
                        k, l = void 0 === b.separator ? ":" : b.separator,
        ...
        searchGrid: function (b) {
            ...
            return this.each(function () {
                ...
                if (e.grid) {
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(q.themodal))[0]) d(a("#fbox_" + a.jgrid.jqID(+e.p.id)));
                    else {
                        var m =
                            a("<div><div id='" + i + "' class='searchFilter' style='overflow:auto'></div></div>").insertBefore("#gview_" + a.jgrid.jqID(e.p.id)),
                            f = "left",
                            h = "";
                        "rtl" == e.p.direction && (f = "right", h = " style='text-align:left'", m.attr("dir", "rtl"));
                        var o = a.extend([], e.p.colModel),
                            w = "<a href='javascript:void(0)' id='" + i + "_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>" + b.Find + "</a>",
                            c = "<a href='javascript:void(0)' id='" + i + "_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>" +
                                b.Reset + "</a>",
                            p = "",
                            g = "",
                            n, k = !1,
                        ...
                        b.layer ? a.jgrid.createModal(q,
                            m, b, "#gview_" + a.jgrid.jqID(e.p.id), a("#gbox_" + a.jgrid.jqID(e.p.id))[0], "#" + a.jgrid.jqID(b.layer), {
                                position: "relative"
                            }) : a.jgrid.createModal(q, m, b, "#gview_" + a.jgrid.jqID(e.p.id), a("#gbox_" + a.jgrid.jqID(e.p.id))[0]);
            ...
            return this.each(function () {
                ...
                function i(d, e, j, h) {
                    ...
                    a(e.p.colModel).each(function (p) {
                        ...
                        if ("cb" !== l && "subgrid" !== l && !0 === this.editable && "rn" !== l) {
                            if (!1 === o) i = "";
                            else if (l == e.p.ExpandColumn && !0 === e.p.treeGrid) i = a("td[role='gridcell']:eq(" + p + ")", e.rows[o]).text();
                            else {
                                try {
                            ...
                            var s =
                                ...
                                x = parseInt(q.rowpos, 10) || t + 1,
                                z = parseInt(2 * (parseInt(q.colpos, 10) || 1), 10);
                ...
                function r(d, e, g) {
                    ...
                    if ("_empty" == d) a(u).each(function () {
                        ...
                        if ((f = a("#" + a.jgrid.jqID(j), "#" + g)) && f.length && null !== f[0])
                            if (t = "", i.defaultValue ?
                                (t = a.isFunction(i.defaultValue) ? i.defaultValue.call(c) : i.defaultValue, "checkbox" == f[0].type ? (m = t.toLowerCase(), 0 > m.search(/(false|0|no|off|undefined)/i) && "" !== m ? (f[0].checked = !0, f[0].defaultChecked = !0, f[0].value = t) : (f[0].checked = !1, f[0].defaultChecked = !1)) : f.val(t)) : "checkbox" == f[0].type ? (f[0].checked = !1, f[0].defaultChecked = !1, t = a(f).attr("offval")) : f[0].type && "select" == f[0].type.substr(0, 6) ? f[0].selectedIndex = 0 : f.val(t), !0 === b[c.p.id].checkOnSubmit || b[c.p.id].checkOnUpdate) b[c.p.id]._savedData[j] =
                                t
                    }), a("#id_g", "#" + g).val(d);
                        ...
                        p && (a('td[role="gridcell"]', p).each(function (f) {
                            ...
                            if ("cb" !== j && "subgrid" !== j && "rn" !== j && !0 === u[f].editable) {
                                if (j == e.p.ExpandColumn && !0 === e.p.treeGrid) l = a(this).text();
                                else try {
                                ...
                                case "custom":
                                    try {
                                        if (u[f].editoptions && a.isFunction(u[f].editoptions.custom_value)) u[f].editoptions.custom_value.call(c, a("#" + j, "#" + g), "set", l);
                                        else throw "e1";
                                    } catch (k) {
                ...
                function s() {
                    var e, f = [!0, "", ""],
                        h = {}, t = c.p.prmNames,
                        i, u, m, o, n, v = a(c).triggerHandler("jqGridAddEditBeforeCheckValues", [a("#" + g), A]);
                    ...
                    for (m in j)
                        if (j.hasOwnProperty(m) && (f = a.jgrid.checkValues.call(c, j[m], m, c), !1 === f[0])) break;
                    q();
                    ...
                    if (f[0] && !b[c.p.id].processing) {
                        ...
                        if (!0 === c.p.treeGrid)
                            for (n in j[u] == t.addoper && (o = a(c).jqGrid("getGridParam", "selrow"), j["adjacency" == c.p.treeGridModel ? c.p.treeReader.parent_id_field : "parent_id"] = o), c.p.treeReader) c.p.treeReader.hasOwnProperty(n) &&
                                ...
                                if (m != "success") {
                                    ...
                                    if (j[u] == t.addoper) {
                                        ...
                                        if (b[c.p.id].closeAfterAdd) {
                                            if (b[c.p.id].reloadAfterSubmit) a(c).trigger("reloadGrid");
                                            else if (c.p.treeGrid === true) a(c).jqGrid("addChildNode", f[2], o, j);
                                            else {
                                    ...
                                    if (b[c.p.id].checkOnSubmit || b[c.p.id].checkOnUpdate) {
                                        ...
                                        if (b[c.p.id]._savedData[c.p.id + "_id"] !=
                                            "_empty")
                                            for (n in b[c.p.id]._savedData) b[c.p.id]._savedData.hasOwnProperty(n) && j[n] && (b[c.p.id]._savedData[n] = j[n])
                                    }
                                }
                ...
                function h() {
                    var d;
                    if ("_empty" !== v && void 0 !== c.p.savedRow && 0 < c.p.savedRow.length && a.isFunction(a.fn.jqGrid.restoreRow))
                        for (d = 0; d < c.p.savedRow.length; d++)
                            if (c.p.savedRow[d].id == v) {
                ...
                if (c.grid && v) {
                    var p = c.p.id,
                        ...
                        l = {
                            ...
                            scrollelm: g
                        }, x = a.isFunction(b[c.p.id].beforeShowForm) ? b[c.p.id].beforeShowForm : !1,
                        z = a.isFunction(b[c.p.id].afterShowForm) ? b[c.p.id].afterShowForm : !1,
                        y = a.isFunction(b[c.p.id].beforeInitData) ? b[c.p.id].beforeInitData : !1,
                        t = a.isFunction(b[c.p.id].onInitializeForm) ?
                            b[c.p.id].onInitializeForm : !1,
                        u = !0,
                        E = 1,
                        H = 0,
                        j, B, F, M, A, g = a.jgrid.jqID(g);
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(l.themodal))[0]) {
                        ...
                        var G = isNaN(d.dataheight) ? d.dataheight : d.dataheight + "px",
                            G = a("<form name='FormPost' id='" + g + "' class='FormGrid' onSubmit='return false;' style='width:100%;overflow:auto;position:relative;height:" + G + ";'></form>").data("disabled", !1),
                            C = a("<table id='" + n + "' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
                        ...
                        y[0].rp = 0;
                        a(C).append(y);
                        var u = (y = "rtl" == c.p.direction ? !0 : !1) ? "nData" : "pData",
                            D = y ? "pData" : "nData";
                        i(v, c, C, E);
                        var u = "<a href='javascript:void(0)' id='" + u + "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
                            ...
                            J = "<a href='javascript:void(0)' id='sData' class='fm-button ui-state-default ui-corner-all'>" +
                                d.bSubmit + "</a>",
                            K = "<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>" + d.bCancel + "</a>",
                            n = "<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='" + n + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>" + (y ? D + u : u + D) + "</td><td class='EditButton'>" + J + K + "</td></tr>" + ("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>" + b[c.p.id].bottominfo +
                                "</td></tr>"),
                            n = n + "</tbody></table>";
                        if (0 < H) {
                            var L = [];
                        ...
                        a(c).triggerHandler("jqGridAddEditInitializeForm", [a("#" + g), A]);
                        t && t.call(c, a("#" + g));
                        "_empty" == v || !b[c.p.id].viewPagerButtons ? a("#pData,#nData", k + "_2").hide() : a("#pData,#nData", k + "_2").show();
                        a(c).triggerHandler("jqGridAddEditBeforeShowForm", [a("#" + g), A]);
                        x && x.call(c, a("#" + g));
                        ...
                        a("#nData", k + "_2").click(function () {
                            ...
                            b[0] = parseInt(b[0], 10);
                            if (b[0] != -1 && b[1][b[0] + 1]) {
                                a(c).triggerHandler("jqGridAddEditClickPgButtons", ["next", a("#" + g), b[1][b[0]]]);
                                var e;
                        ...
                        a("#pData", k + "_2").click(function () {
                            ...
                            if (b[0] != -1 && b[1][b[0] - 1]) {
                                ...
                                r(b[1][b[0] - 1], c, g);
                                a(c).jqGrid("setSelection", b[1][b[0] - 1]);
                                a(c).triggerHandler("jqGridAddEditAfterClickPgButtons", ["prev", a("#" + g), b[1][b[0]]]);
            ...
            return this.each(function () {
                ...
                function i(b, c, e, f) {
                    var j, g, h, l = 0,
                        i, k, m = [],
                        n = !1,
                        o, p = "<td class='CaptionTD form-view-label ui-widget-content' width='" + d.labelswidth + "'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>",
                        v = "",
                        s = ["integer", "number", "currency"],
                        q = 0,
                        r = 0,
                        x, z, w;
                    ...
                    a(c.p.colModel).each(function (b) {
                        ...
                        if ("cb" !== j && "subgrid" !== j && "rn" !== j && w) {
                            ...
                            var d = a.extend({}, {
                                ...
                                t = parseInt(d.rowpos, 10) || l + 1,
                                o = parseInt(2 * (parseInt(d.colpos, 10) || 1), 10);
                            if (d.rowabove) {
                ...
                if (m.grid && v) {
                    var f = m.p.id,
                        h = "ViewGrid_" + a.jgrid.jqID(f),
                        o = "ViewTbl_" + a.jgrid.jqID(f),
                        w = "ViewGrid_" + f,
                        c = "ViewTbl_" + f,
                        p = {
                            themodal: "viewmod" + f,
                            ...
                            scrollelm: h
                        }, g = a.isFunction(b[m.p.id].beforeInitData) ? b[m.p.id].beforeInitData : !1,
                        n = !0,
                        k = 1,
                        l = 0;
                    if (void 0 !== a("#" + a.jgrid.jqID(p.themodal))[0]) {
                        ...
                        var x = isNaN(d.dataheight) ? d.dataheight : d.dataheight + "px",
                            w = a("<form name='FormPost' id='" + w + "' class='FormGrid' style='width:100%;overflow:auto;position:relative;height:" +
                                x + ";'></form>"),
                            z = a("<table id='" + c + "' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");
            ...
            return this.each(function () {
                ...
                if (e.grid && v) {
                    var i = a.isFunction(b[e.p.id].beforeShowForm),
                        r = a.isFunction(b[e.p.id].afterShowForm),
                        q = a.isFunction(b[e.p.id].beforeInitData) ? b[e.p.id].beforeInitData : !1,
                        s = e.p.id,
                        m = {},
                        f = !0,
                        h = "DelTbl_" + a.jgrid.jqID(s),
                        o, w, c, p, g = "DelTbl_" + s,
                        n = {
                            themodal: "delmod" + s,
                            modalhead: "delhd" + s,
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(n.themodal))[0]) {
                        ...
                        var k = isNaN(b[e.p.id].dataheight) ? b[e.p.id].dataheight : b[e.p.id].dataheight + "px",
                            g = "<div id='" + g + "' class='formdata' style='width:100%;overflow:auto;position:relative;height:" + k + ";'><table class='DelTable'><tbody><tr id='DelError' style='display:none'><td class='ui-state-error'></td></tr>" + ("<tr id='DelData' style='display:none'><td >" + v + "</td></tr>"),
                            g = g + ('<tr><td class="delmsg" style="white-space:pre;">' +
                                b[e.p.id].msg + "</td></tr><tr><td >&#160;</td></tr>"),
                            g = g + "</tbody></table></div>" + ("<table cellspacing='0' cellpadding='0' border='0' class='EditTable' id='" + h + "_2'><tbody><tr><td><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>" + ("<a href='javascript:void(0)' id='dData' class='fm-button ui-state-default ui-corner-all'>" + d.bSubmit + "</a>") + "&#160;" + ("<a href='javascript:void(0)' id='eData' class='fm-button ui-state-default ui-corner-all'>" + d.bCancel +
                                "</a>") + "</td></tr></tbody></table>");
                            ...
                            if (f[0] && !b[e.p.id].processing) {
                                ...
                                g = a.extend({
                                    ...
                                    complete: function (c, g) {
                                        ...
                                        } else a.isFunction(b[e.p.id].afterSubmit) && (f = b[e.p.id].afterSubmit.call(e, c, o)); if (f[0] === false) {
                        ...
                        for (w = 0; w < o; w++) {
                            ...
                            d.edit && (h = a("<td class='ui-pg-button ui-corner-all'></td>"),
                                e = e || {}, a(h).append("<div class='ui-pg-div'><span class='ui-icon " + d.editicon + "'></span>" + d.edittext + "</div>"), a("tr", g).append(h), a(h, g).attr({
                                    ...
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        var b = f.p.selrow;
                                        if (b) a.isFunction(d.editfunc) ? d.editfunc.call(f, b) : a(f).jqGrid("editGridRow", b, e);
                                        else {
                            ...
                            d.view && (h = a("<td class='ui-pg-button ui-corner-all'></td>"),
                                s = s || {}, a(h).append("<div class='ui-pg-div'><span class='ui-icon " + d.viewicon + "'></span>" + d.viewtext + "</div>"), a("tr", g).append(h), a(h, g).attr({
                                    ...
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        var b = f.p.selrow;
                                        if (b) a.isFunction(d.viewfunc) ? d.viewfunc.call(f, b) : a(f).jqGrid("viewGridRow", b, s);
                                        else {
                                            a.jgrid.viewModal("#" + m.themodal, {
                                                gbox: "#gbox_" + a.jgrid.jqID(f.p.id),
                                                jqm: true
                                ...
                                r = r || {}, a(h).append("<div class='ui-pg-div'><span class='ui-icon " + d.delicon + "'></span>" + d.deltext + "</div>"), a("tr", g).append(h), a(h, g).attr({
                                    ...
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        ...
                                        if (f.p.multiselect) {
                                            b = f.p.selarrrow;
                                            b.length === 0 && (b = null)
                                        } else b = f.p.selrow; if (b) a.isFunction(d.delfunc) ? d.delfunc.call(f, b) : a(f).jqGrid("delGridRow", b, r);
                                        else {
                                            a.jgrid.viewModal("#" + m.themodal, {
                                                gbox: "#gbox_" + a.jgrid.jqID(f.p.id),
                                                jqm: true
        ...
        GridToForm: function (b, d) {
            return this.each(function () {
                ...
                if (e.grid) {
                    ...
                    if (r)
                        for (i in r) r.hasOwnProperty(i) && (a("[name=" + a.jgrid.jqID(i) +
                            "]", d).is("input:radio") || a("[name=" + a.jgrid.jqID(i) + "]", d).is("input:checkbox") ? a("[name=" + a.jgrid.jqID(i) + "]", d).each(function () {
                            if (a(this).val() == r[i]) a(this)[e.p.useProp ? "prop" : "attr"]("checked", !0);
            ...
            if (!this.filter) {
                ...
                if (n) {
                    ...
                    this.createTableForGroup = function (g, k) {
                        ...
                        if (void 0 !== g.groups)
                            for (c = 0; c < g.groups.length; c++) d = a("<tr></tr>"), e.append(d), h = a("<td class='first'></td>"),
...
(function (a) {
    ...
    a.jgrid.extend({
        ...
        saveRow: function (b, c, e, o, l, g, n) {
            ...
            else if (a.isFunction(c) && (f.successfunc = c), void 0 !== e && (f.url = e), void 0 !== o && (f.extraparam = o), a.isFunction(l) && (f.aftersavefunc = l),
            ...
            if ("1" === i) {
                ...
                if (h) {
                    h[p.oper] = p.editoper;
                    if (void 0 === h[i]) h[i] = b;
                    else if (q.id !== d.p.idPrefix + h[i] && (p = a.jgrid.stripPref(d.p.idPrefix, b), void 0 !== d.p._index[p] && (d.p._index[h[i]] = d.p._index[p], delete d.p._index[p]), b = d.p.idPrefix + h[i], a(q).attr("id", b), d.p.selrow === u && (d.p.selrow = b), a.isArray(d.p.selarrrow) &&
                ...
                if ("clientArray" == f.url) {
                    ...
                    a(q).attr("editable", "0");
                    for (i = 0; i < d.p.savedRow.length; i++)
                        if (d.p.savedRow[i].id == u) {
                            t = i;
                            break
                        }
        ...
        restoreRow: function (b, c) {
            ...
            return this.each(function () {
                ...
                if (c.grid) {
                    ...
                    if (n !== false) {
                        for (f = 0; f < c.p.savedRow.length; f++)
                            if (c.p.savedRow[f].id ==
                                b) {
                                e = f;
                                break
                            }
    ...
    c.extend(c.jgrid, {
        template: function (d) {
            ...
            return d.replace(/\{([\w\-]+)(?:\:([\w\.]*)(?:\((.*?)?\))?)?\}/g, function (d, g) {
                ...
                for (e = 0; e < a; e++)
                    if (c.isArray(h[e]))
                        for (var b = h[e], j = b.length; j--;)
                            if (g === b[j].nm) return b[j].v
            })
        }
    });
    c.jgrid.extend({
            ...
            this.each(function () {
                ...
                if (j.hasClass(f)) {
                    if (h.showSummaryOnHide) {
                        if (b)
                            for (; b && !(c(b).hasClass("jqfoot") && parseInt(c(b).attr("jqfootlevel"), 10) <= a);) c(b).hide(), b = b.nextSibling
                    } else if (b)
                        for (; b && !c(b).hasClass(e + "_" +
                            ("" + a)) && !c(b).hasClass(e + "_" + ("" + (a - 1)));) c(b).hide(), b = b.nextSibling;
                    j.removeClass(f).addClass(g);
                    k = !0
                } else {
                    if (b)
                        for (; b && !c(b).hasClass(e + "_" + ("" + a)) && !c(b).hasClass(e + "_" + ("" + (a - 1)));) c(b).show(), (h = c(b).find("span.tree-wrap-" + this.p.direction)) && c(h).hasClass(g) && c(h).removeClass(g).addClass(f), b = b.nextSibling;
        ...
        setTreeNode: function (a, c) {
            return this.each(function () {
                ...
                if (b.grid && b.p.treeGrid)
                    for (var h = b.p.expColInd, e = b.p.treeReader.expanded_field, i = b.p.treeReader.leaf_field, g = b.p.treeReader.level_field, f = b.p.treeReader.icon_field, l = b.p.treeReader.loaded, k, m, n, j; a < c;) j = b.p.data[b.p._index[b.rows[a].id]], "nested" == b.p.treeGridModel && !j[i] && (k = parseInt(j[b.p.treeReader.left_field], 10), m = parseInt(j[b.p.treeReader.right_field], 10), j[i] = m === k + 1 ? "true" : "false", b.rows[a].cells[b.p._treeleafpos].innerHTML =
                        j[i]), k = parseInt(j[g], 10), 0 === b.p.tree_root_level ? (n = k + 1, m = k) : (n = k, m = k - 1), n = "<div class='tree-wrap tree-wrap-" + b.p.direction + "' style='width:" + 18 * n + "px;'>", n += "<div style='" + ("rtl" == b.p.direction ? "right:" : "left:") + 18 * m + "px;' class='ui-icon ", void 0 !== j[l] && (j[l] = "true" == j[l] || !0 === j[l] ? !0 : !1), "true" == j[i] || !0 === j[i] ? (n += (void 0 !== j[f] && "" !== j[f] ? j[f] : b.p.treeIcons.leaf) + " tree-leaf treeclick", j[i] = !0, m = "leaf") : (j[i] = !1, m = ""), j[e] = ("true" == j[e] || !0 === j[e] ? !0 : !1) && (j[l] || void 0 === j[l]), n = !1 === j[e] ?
        ...
        setTreeGrid: function () {
            return this.each(function () {
                ...
                if (a.p.treeGrid) {
                    ...
                    for (e in a.p.colModel)
                        if (a.p.colModel.hasOwnProperty(e))
                            for (i in h = a.p.colModel[e].name, h == a.p.ExpandColumn && !b && (b = !0, a.p.expColInd = c), c++, a.p.treeReader) a.p.treeReader.hasOwnProperty(i) && a.p.treeReader[i] == h && g.push(h);
        ...
        getNodeAncestors: function (a) {
            ...
            this.each(function () {
                if (this.grid && this.p.treeGrid)
                    for (var b = d(this).jqGrid("getNodeParent", a); b;) c.push(b), b = d(this).jqGrid("getNodeParent", b)
            });
            return c
        },
        ...
        delTreeNode: function (a) {
            return this.each(function () {
                ...
                if (this.grid && this.p.treeGrid && (b = this.p._index[a], void 0 !== b)) {
                    ...
                    if (0 < l.length)
                        for (b = 0; b < l.length; b++) d(this).jqGrid("delRowData",
                            l[b][c]);
        ...
        addChildNode: function (a, c, b, h) {
            ...
            if (b) {
                ...
                if (void 0 === a || null === a) {
                    p = e.p.data.length - 1;
                    if (0 <= p)
                        for (; 0 <= p;) j = Math.max(j, parseInt(e.p.data[p][e.p.localReader.id], 10)), p--;
                    a = j + 1
                }
                var v = d(e).jqGrid("getInd", c);
                u = !1;
                if (void 0 === c || null === c || "" === c) s = c = null, j = "last", t = e.p.tree_root_level, p = e.p.data.length + 1;
                else if (j = "after", r = e.p._index[c], q = e.p.data[r], c = q[e.p.localReader.id], t = parseInt(q[f], 10) + 1, p = d(e).jqGrid("getFullTreeNode",
                ...
                if ("nested" ===
                    ...
                    if (null !== c) {
                        ...
                        f = f.select();
                        if (f.length)
                            for (o in f) f.hasOwnProperty(o) && (f[o][k] = f[o][k] > g ? parseInt(f[o][k], 10) + 2 : f[o][k], f[o][m] = f[o][m] >= g ? parseInt(f[o][m], 10) + 2 : f[o][m]);
                        b[k] = g;
                        b[m] = g + 1
                    } else {
