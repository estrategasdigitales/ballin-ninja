    ...
    <div id= "type4" class="rectangulo_abajo_secciones">
      <div class="textos"><!-- InstanceBeginEditable name="contenido" -->
		  <?php
			...
			$mensaje.="<b>Se enteró del programa através de:</b><br />";
			...
			$mensaje.="<br /><b>Información Personal:</b><br /><br />";
			...
			$mensaje.="<b>Del./Mpo./Población:</b> $del_mpo_pob<br />";
			...
			$mensaje.="<br /><b>Información Académica:</b><br /><br />";
			$mensaje.="<b>Grado académico:</b> $gradoAcademico<br />";
			$mensaje.="<b>Institución de estudios:</b> $inst_estudios<br />";
			$mensaje.="<b>Porqué eligió a la Ibero:</b> $porque_elegiste_a_la_ibero<br />";
			$mensaje.="<b>Ex Alumno UIA:</b> $exAlumnoUIA<br />";
			
			$mensaje.="<br /><b>Información Laboral:</b><br /><br />";
			$mensaje.="<b>Empresa:</b> $empresa<br />";
			$mensaje.="<b>Depto.:</b> $empresa_depto<br />";
			$mensaje.="<b>Puesto:</b> $empresa_puesto<br />";
			$mensaje.="<b>Dirección:</b> $empresa_direccion<br />";
			$mensaje.="<b>Del./Mpo./Población:</b> $empresa_del_mpo_pob<br />";
			$mensaje.="<b>C.P.:</b> $empresa_cp<br />";
			$mensaje.="<b>Ciudad:</b> $empresa_ciudad<br />";
			$mensaje.="<b>Estado:</b> $empresa_estado<br />";
			$mensaje.="<b>Teléfono:</b> $empresa_tel<br />";
