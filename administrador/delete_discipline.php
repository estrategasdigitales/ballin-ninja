...
if((isset($_GET['id_article']) && ($_GET['id_article']) != ""))
{
	...
	$query_discipline =  sprintf("SELECT * FROM discipline_articles WHERE id_article=%s", GetSQLValueString($_GET['id_article'], "int"));
	...
	if((isset($_POST['delete']) && ($_POST['delete']) == "Eliminar"))
	{
	 //Para borrar de la base
	  $deleteSQL = sprintf("DELETE FROM discipline_articles WHERE id_article=%s", GetSQLValueString($_GET['id_article'], "int"));
	  mysql_select_db($database_otono2011, $otono2011);
	  $Result1 = mysql_query($deleteSQL, $otono2011) or die(mysql_error());
	 
	 $deleteGoTo = "admin_discipline_articles.php?id_discipline=1";
...
<div id="container">
  ...
  <div id="contenedor_irregular_index" style="width:800px;"><!-- InstanceBeginEditable name="contenido" -->
	<form method="post" name="form1" id="form1" action="delete_discipline.php?id_article=<?php echo $_GET['id_article'];?>">
        ...
        <tr>
            ...
            <td>&nbsp;</td>
                ...
                <tr>
        	<td>&nbsp;</td>
        	<td colspan="2" align="center">¿ Seguro deseas eliminar el aviso: <?php echo $row_discipline['title'];?> ?</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
