...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $updateSQL = sprintf("UPDATE site_fechas_idiomas SET id_program=%s, nivel=%s, subnivel=%s, inicio=%s, duracion=%s, horario=%s, horario_mat=%s, horario_vesp=%s, periodo=%s, costo=%s WHERE id_fecha_idioma=%s",
...
$query_idiomas_editar = "SELECT * FROM site_fechas_idiomas WHERE id_fecha_idioma =".$_GET['id_fecha_idioma'];
$idiomas_editar = mysql_query($query_idiomas_editar, $otono2011) or die(mysql_error());
$row_idiomas_editar = mysql_fetch_assoc($idiomas_editar);
$totalRows_idiomas_editar = mysql_num_rows($idiomas_editar);
?>
...
<div id="container">
  ...
  <div id="contenedor_irregular_index" style="width:800px;"><!-- InstanceBeginEditable name="contenido" -->
            ...
            <form action="fechas_idiom_editar.php" method="post" name="form1" id="form1">
	<table border="0" align="left" cellpadding="5" cellspacing="0">
		<tr valign="baseline">
			...
			<td colspan="2">
				<select name="id_program" id="id_program">
					<?php
					do {  
            if($row_programas['id_program'] == $row_idiomas_editar['id_program']){
					?>
          <option selected="selected" value="<?php echo $row_programas['id_program']?>"><?php echo $row_programas['program_name']?></option>
          <?php }else{ ?>
		...
		<tr valign="baseline">
			...
			<td colspan="2"><input type="text" name="nivel" value="<?php echo $row_idiomas_editar['nivel'] ?>" size="32" /></td>
		</tr>
		<tr valign="baseline">
			<td align="right" valign="top" nowrap="nowrap"><strong>Subnivel</strong></td>
			<td colspan="2"><input type="text" name="subnivel" value="<?php echo $row_idiomas_editar['subnivel'] ?>" size="32" /></td>
		</tr>
		<tr valign="baseline">
			<td align="right" valign="top" nowrap="nowrap"><strong>Inicio:</strong></td>
			<td colspan="2"><input type="text" name="inicio" value="<?php echo $row_idiomas_editar['inicio'] ?>" size="32" />
		...
		<tr valign="baseline">
			...
			<td colspan="2"><input type="text" name="duracion" value="<?php echo $row_idiomas_editar['duracion'] ?>" size="32" /></td>
		</tr>
		<tr valign="baseline">
			<td align="right" valign="top" nowrap="nowrap"><strong>Horario:</strong></td>
			<td colspan="2"><input type="text" name="horario" value="<?php echo $row_idiomas_editar['horario'] ?>" size="32" /></td>
		</tr>
		<tr valign="baseline">
			<td align="right" valign="top" nowrap="nowrap"><strong>Horario Mattutino:</strong></td>
			<td colspan="2"><input type="text" name="horario_mat" value="<?php echo $row_idiomas_editar['horario_mat'] ?>" size="32" /></td>
		</tr>
		<tr valign="baseline">
			<td align="right" valign="top" nowrap="nowrap"><strong>Horario vespertino:</strong></td>
			<td colspan="2"><input type="text" name="horario_vesp" value="<?php echo $row_idiomas_editar['horario_vesp'] ?>" size="32" /></td>
		</tr>
		<tr valign="baseline">
			<td align="right" valign="top" nowrap="nowrap"><strong>Costo:</strong></td>
			<td colspan="2"><input type="text" name="costo" value="<?php echo $row_idiomas_editar['costo'] ?>" size="32" /></td>
		</tr>
    <tr valign="baseline">
      <td align="right" valign="top" nowrap="nowrap"><strong>Periodo:</strong></td>
      <td colspan="2">
        <select name="periodo">
          <?php switch($row_idiomas_editar['periodo']){
                  case "p":
                  $options = '<option value="p" selected="selected">Primavera</option><option value="v">Verano</option><option value="o">Oto&ntilde;o</option>';
                  break;
                  case "v":
                  $options = '<option value="v" selected="selected">Verano</option><option value="p">Primavera</option><option value="o">Oto&ntilde;o</option>';
                  break;
                  case "o":
                  $options = '<option value="o" selected="selected">Oto&ntilde;o</option><option value="p">Primavera</option><option value="v">Verano</option>';
                  break;
          }
          echo $options;
          ?>
	...
	<input type="hidden" name="id_fecha_idioma" value="<?php echo $_GET['id_fecha_idioma']; ?>" />
