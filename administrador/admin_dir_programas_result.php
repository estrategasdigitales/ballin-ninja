...
$name = $_POST['nombre_programa'];
mysql_select_db($database_otono2011, $otono2011);
      $query_programa = "SELECT id_program, program_name FROM site_programs WHERE program_name LIKE '%".$name."%' ORDER BY program_name ASC"; 
    ...
    <div class="contenedor_programas_result">
      ...
      if($totalRows_programa > 0){
          while($row_programa = mysql_fetch_assoc($programa)){
            ...
            echo '<a class="profr_list" href="programas_editar.php?id_program='.$row_programa["id_program"].'">'.$row_programa['program_name'].'</a>';
