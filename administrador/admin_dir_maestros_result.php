...
mysql_select_db($database_otono2011, $otono2011);
      $query_programa = "SELECT nombre_maestro, id_maestro FROM site_maestros WHERE nombre_maestro LIKE '%".$name."%' ORDER BY nombre_maestro ASC"; 
    ...
    <div class="contenedor_programas_result">
      ...
      if($totalRows_programa > 0){
          while($row_programa = mysql_fetch_assoc($programa)){
            ...
            echo '<a class="profr_list" href="editar_maestro.php?id_maestro='.$row_programa["id_maestro"].'">'.$row_programa['nombre_maestro'].'</a>';
