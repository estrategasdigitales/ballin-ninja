...
mysql_select_db($database_otono2011, $otono2011);
      $query_programa = "SELECT id_sede, nombre_sede FROM site_sedes WHERE nombre_sede LIKE '%".$name."%' ORDER BY nombre_sede ASC"; 
    ...
    <table  border="0" cellpadding="5" cellspacing="0" class="tablas" width="100%">
      ...
      if($totalRows_programa > 0){
          while($row_programa = mysql_fetch_assoc($programa)){
            ...
            echo '<tr><td><a class="profr_list" href="edit_sede.php?id_sede='.$row_programa["id_sede"].'">'.$row_programa['nombre_sede'].'</a></td><tr>';
