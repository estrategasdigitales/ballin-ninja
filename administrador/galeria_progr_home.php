...
<!-- Termina llamada a menú de secciones-->
 ...
 <h1> Galer&iacute;as en Programas </h1>
<table  border="0" cellpadding="5" cellspacing="0" class="tablas" align="center">
	<tr class="titulo_tabla">
		...
		<td>Cancelado</td-->
		<td colspan="2">
        <input type="button" value="Nueva Galer&iacute;a" onclick="javascript:window.location='galeria_programas_nuevo.php'">
        </td>
	  </tr>
...
<table border="0" align="center">
	<tr>
    <td><?php echo "De la galer&iacute;a ".($startRow_programas + 1)." al ".($startRow_programas + $cont); ?></td>
