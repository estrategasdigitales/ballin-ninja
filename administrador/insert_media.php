...
//para cargar fotos *********************************************************************** 
  ...
  $insertSQL = sprintf("INSERT INTO media_articles (id_program, `date`, title, content, picture, thumbnail) VALUES (%s, %s, %s, %s, %s)",
            ...
            <tr valign="baseline">
              ...
              <td>
                ...
                <tr valign="baseline">
                  ...
                  <td><textarea name="content" id="content" rows="5" cols="65"> </textarea></td>
                </tr>
                <tr valign="baseline">
