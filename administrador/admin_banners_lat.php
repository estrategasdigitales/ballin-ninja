...
$query_Recordset1 = "SELECT * FROM banners_lat ORDER BY id_banner DESC";
...
<table width="700" border="0" align="center" cellpadding="5" cellspacing="0" class="tablas">
  <tr class="titulo_tabla">
    <td width="211">Banner</td>
    <td width="326">Destino</td>
    <td width="131"><input type="button" onclick="javascript:window.location='insert_banner.php'" value="Agregar Nuevo"/></td>
  </tr>
  <?php while($row_Recordset1 = mysql_fetch_assoc($Recordset1)) { ?>
    <tr>
      <td><img src="../imagenes/banners/<?php echo $row_Recordset1['img_banner']; ?>" width="100"/></td>
