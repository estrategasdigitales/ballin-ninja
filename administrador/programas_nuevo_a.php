...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO site_programs (id_program, id_discipline, id_discipline_alterna, program_type, program_name, program_colaboracion, program_colaboracion_img, program_new, `description`, observaciones, id_maestro, duration, costo_curso, cost_inscripcion, costo_modulo, id_encargado, banner, banner_url, program_pdf, cancelado, periodo, idioma) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<div id="container">
  ...
  <div id="contenedor_irregular_index" style="width:800px;"><!-- InstanceBeginEditable name="contenido" -->
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" enctype="multipart/form-data">
      <table align="center">
        <tr valign="baseline">
          <td align="right" valign="top" nowrap="nowrap">Disciplina:</td>
        ...
        <tr valign="baseline">
          <td align="right" valign="top" nowrap="nowrap">Disciplina alterna:</td>
          <td colspan="2"> (1)
        ...
        <tr valign="baseline">
          <td align="right" valign="top" nowrap="nowrap">Tipo:</td>
          <td colspan="2" valign="baseline"><table>
              ...
              <tr>
                <td><input type="radio" name="program_type" value="curso" />
                  curso</td>
              </tr>
            </table></td>
        </tr>
        <tr valign="baseline">
          <td align="right" valign="top" nowrap="nowrap">Nombre:</td>
          <td colspan="2"><input type="text" name="program_name" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td align="right" valign="top" nowrap="nowrap">En colaboraci&oacute;n con:</td>
          <td colspan="2"><input type="text" name="program_colaboracion" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td align="right" valign="top" nowrap="nowrap">Colaborador img:</td>
          <td colspan="2"><input type="file" name="program_colaboracion_img" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td align="right" valign="top" nowrap="nowrap">Nuevo:</td>
          <td colspan="2"><input type="checkbox" name="program_new" value="" /></td>
        </tr>
        <tr valign="baseline">
          <td align="right" valign="top" nowrap="nowrap">Descripci&oacute;n:</td>
          <td colspan="2"><textarea name="description" cols="50" rows="50"></textarea></td>
        </tr>
        <tr valign="baseline">
          <td align="right" valign="top" nowrap="nowrap">Observaciones:</td>
          <td colspan="2"><textarea name="observaciones" cols="50" rows="10"></textarea></td>
        </tr>
        <tr valign="baseline">
          <td align="right" valign="top" nowrap="nowrap">Maestro:</td>
          <td colspan="2"> (1)
        ...
        <tr valign="baseline">
          <td align="right" valign="top" nowrap="nowrap">Duraci&oacute;n:</td>
          <td colspan="2"><input type="text" name="duration" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td align="right" valign="top" nowrap="nowrap">Costo curso:</td>
          <td colspan="2"><input type="text" name="costo_curso" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td align="right" valign="top" nowrap="nowrap">Costo inscripcion:</td>
          <td colspan="2"><input type="text" name="cost_inscripcion" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td align="right" valign="top" nowrap="nowrap">Costo m&oacute;dulo:</td>
          <td colspan="2"><input type="text" name="costo_modulo" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td align="right" valign="top" nowrap="nowrap">Encargado:</td>
          <td colspan="2"> (1)
        ...
        <tr valign="baseline">
          <td align="right" valign="top" nowrap="nowrap">Banner:</td>
          <td colspan="2"><input type="file" name="banner" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td align="right" valign="top" nowrap="nowrap">Banner URL.</td>
          <td colspan="2"><input type="text" name="banner_url" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td align="right" valign="top" nowrap="nowrap">Programa PDF:</td>
          <td colspan="2"><input type="file" name="program_pdf" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td align="right" valign="top" nowrap="nowrap">Cancelado:</td>
          <td colspan="2"><input type="checkbox" name="cancelado" value="" /></td>
        </tr>
        <tr valign="baseline">
          <td align="right" valign="top" nowrap="nowrap">Periodo:</td>
          <td colspan="2" valign="baseline"><table>
              <tr>
        ...
        <tr valign="baseline">
          <td align="right" valign="top" nowrap="nowrap">Idioma:</td>
