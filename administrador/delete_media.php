...
if((isset($_GET['id_article']) && ($_GET['id_article']) != ""))
{
	...
	if((isset($_POST['delete']) && ($_POST['delete']) == "Eliminar"))
	{
	 //Para borrar de la base
	  $deleteSQL = sprintf("DELETE FROM media_articles WHERE id_article=%s",GetSQLValueString($_GET['id_article'], "int"));
	  mysql_select_db($database_otono2011, $otono2011);
	  $Result1 = mysql_query($deleteSQL, $otono2011) or die(mysql_error());
	 
	 $deleteGoTo = "admin_media_articles.php";
...
<div id="container">
  ...
  <div id="contenedor_irregular_index" style="width:800px;"><!-- InstanceBeginEditable name="contenido" -->
	<form method="post" name="form1" id="form1" action="delete_media.php?id_article=<?php echo $_GET['id_article'];?>">
        ...
        <tr>
            ...
            <td>&nbsp;</td>
                ...
                <tr>
        	<td>&nbsp;</td>
        	<td colspan="2" align="center">¿ Seguro deseas eliminar el artículo <?php echo $row_medias['title'];?> ?</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
