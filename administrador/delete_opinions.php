...
if((isset($_GET['id_opinion']) && ($_GET['id_opinion']) != ""))
{
	//Para poner elemento a eliminar
	mysql_select_db($database_otono2011, $otono2011);;
	$query_opinion =  sprintf("SELECT * FROM community_opinions WHERE id_opinion=%s", GetSQLValueString($_GET['id_opinion'], "int"));
	$opinion = mysql_query($query_opinion, $otono2011) or die(mysql_error());
	$row_opinion= mysql_fetch_assoc($opinion);
	
	if((isset($_POST['delete']) && ($_POST['delete']) == "Eliminar"))
	{
	 //Para borrar de la base
	  $deleteSQL = sprintf("DELETE FROM community_opinions WHERE id_opinion=%s", GetSQLValueString($_GET['id_opinion'], "int"));
	  mysql_select_db($database_otono2011, $otono2011);
	  $Result1 = mysql_query($deleteSQL, $otono2011) or die(mysql_error());
	 
	 $deleteGoTo = "admin_opinions.php";
...
<div id="container">
  ...
  <div id="contenedor_irregular_index" style="width:800px;"><!-- InstanceBeginEditable name="contenido" -->
	<form method="post" name="form1" id="form1" action="delete_opinions.php?id_opinion=<?php echo $_GET['id_opinion'];?>">
        ...
        <tr>
            ...
            <td>&nbsp;</td>
                ...
                <tr>
        	<td>&nbsp;</td>
        	<td colspan="2" align="center">¿ Seguro deseas eliminar la opinión de: <?php echo $row_opinion['full_name'];?> ?</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
