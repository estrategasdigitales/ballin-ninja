...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO site_directory (nombre, telefono, extension, correo) VALUES (%s, %s, %s, %s)",
...
<div id="container">
  ...
  <div id="contenedor_irregular_index" style="width:800px;"><!-- InstanceBeginEditable name="contenido" -->
            ...
            <form action="nuevo_dir_dec.php" method="post" name="form1" id="form1">
	<table border="0" align="left" cellpadding="5" cellspacing="0">
		<tr valign="baseline">
			<td nowrap="nowrap" align="right"><strong>Nombre:</strong></td>
			<td colspan="2"><input type="text" name="nombre" value="" size="32"/>
		</tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td colspan="2"><input type="text" name="extension" value="" size="32"/>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right"><strong>Correo:</strong></td>
      <td colspan="2"><input type="text" name="correo" value="" size="32"/>
    </tr>
    <tr align="center">
