...
mysql_select_db($database_otono2011, $otono2011);
      $query_programa = "SELECT nombre, id_encargado FROM site_directory WHERE nombre LIKE '%".$name."%' ORDER BY nombre ASC"; 
    ...
    <div class="contenedor_programas_result">
      ...
      if($totalRows_programa > 0){
          while($row_programa = mysql_fetch_assoc($programa)){
            ...
            echo '<a class="profr_list" href="edit_encargado.php?id_encargado='.$row_programa["id_encargado"].'">'.$row_programa['nombre'].'</a>';
