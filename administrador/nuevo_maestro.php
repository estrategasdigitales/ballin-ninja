...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO site_maestros (nombre_maestro, titulo_maestro, telefono, mail, cv, sexo) VALUES (%s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['nombre_maestro'], "text"),
                       GetSQLValueString($_POST['titulo_maestro'], "text"),
  ...
  <div id="contenedor_irregular_index" style="width:800px;"><!-- InstanceBeginEditable name="contenido" -->
	...
	<table border="0" align="left" cellpadding="5" cellspacing="0">
		<tr valign="baseline">
			...
			<td colspan="2"><input type="text" name="nombre_maestro" value="" size="32"/>
		</tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right"><strong>T&iacute;tulo:</strong></td>
      <td colspan="2"><input type="text" name="titulo_maestro" value="" size="32"/>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right"><strong>Tel&eacute;fono:</strong></td>
      <td colspan="2"><input type="text" name="telefono" value="" size="32"/>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right"><strong>Correo:</strong></td>
      <td colspan="2"><input type="text" name="mail" value="" size="32"/>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right" valign="top"><strong>C.V.:</strong></td>
      <td colspan="2"><textarea name="cv" id="cv"></textarea>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right"><strong>Sexo:</strong></td>
      <td colspan="2">
        <select name="sexo">
            <option value="0" disabled="disabled" selected="selected"> Elige una opci&oacute;n </option>
