...
$sql = mysql_query("SELECT * FROM site_sedes WHERE id_sede=".$_GET['id_sede'], $otono2011);
$row_sql = mysql_fetch_assoc($sql);

if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {

  $insertSQL = sprintf("UPDATE site_sedes SET nombre_sede=%s WHERE id_sede=".$_POST['id_sede'],
  ...
  <form action="edit_sede.php" method="post" name="form1" id="form1">
	<table border="0" align="left" cellpadding="5" cellspacing="0">
		<tr valign="baseline">
			...
			<td colspan="2"><textarea id="sede" name="sede"><?php echo $row_sql['nombre_sede']?></textarea></td>
		</tr align="right">
	...
	<input type="hidden" name="id_sede" value="<?php echo $_GET['id_sede']; ?>" />
