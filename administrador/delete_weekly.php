...
if((isset($_GET['id_article']) && ($_GET['id_article']) != ""))
{
	...
	$query_weekly =  sprintf("SELECT * FROM weekly_articles WHERE id_article=%s", GetSQLValueString($_GET['id_article'], "int"));
	...
	if((isset($_POST['delete']) && ($_POST['delete']) == "Eliminar"))
	{
	 //Para borrar de la base
	  $deleteSQL = sprintf("DELETE FROM weekly_articles WHERE id_article=%s",GetSQLValueString($_GET['id_article'], "int"));
	  mysql_select_db($database_otono2011, $otono2011);
	  $Result1 = mysql_query($deleteSQL, $otono2011) or die(mysql_error());
	 
	 $deleteGoTo = "admin_weekly.php";
...
<div id="container">
  ...
  <div id="contenedor_irregular_index" style="width:800px;"><!-- InstanceBeginEditable name="contenido" -->
	<form method="post" name="form1" id="form1" action="delete_weekly.php?id_article=<?php echo $_GET['id_article'];?>">
        ...
        <tr>
            ...
            <td>&nbsp;</td>
                ...
                <tr>
        	<td>&nbsp;</td>
        	<td colspan="2" align="center">¿ Seguro deseas eliminar el artículo <?php echo $row_weekly['title'];?> ?</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
