...
$query_progs_diplos = "SELECT * FROM seg_dec_programas WHERE program_type = 'diplomado' AND cancelado = 0 AND periodo = 'o' AND idioma = 0 AND (id_discipline  = ".$disciplina." OR ".$disciplina." IN(id_discipline_alterna) OR id_discipline_alterna_2 = ".$disciplina.") ORDER BY program_name ASC";
...
$query_progs_cursos = "SELECT * FROM seg_dec_programas WHERE program_type = 'curso' AND cancelado = 0 AND periodo = 'o' AND idioma = 0 AND (id_discipline = ".$disciplina." OR id_discipline_alterna  = ".$disciplina." OR id_discipline_alterna_2  = ".$disciplina.") ORDER BY idioma ASC, program_name ASC"; 
...
$query_progs_progs = "SELECT * FROM seg_dec_programas WHERE program_type = 'programa' AND cancelado = 0 AND periodo = 'o' AND id_discipline = ".$disciplina." ORDER BY idioma ASC, program_name ASC";
...
$query_progs_hp = "SELECT * FROM seg_dec_programas WHERE program_type = 'programahp' AND cancelado = 0 AND periodo = 'o' AND id_discipline = ".$disciplina." OR id_discipline_alterna = ".$disciplina." ORDER BY program_name ASC";
...
$query_progs_cursos_i = "SELECT * FROM seg_dec_programas WHERE idioma = 1 AND cancelado = 0 AND (id_discipline = ".$disciplina." OR id_discipline_alterna = ".$disciplina.") ORDER BY idioma ASC, program_name ASC";
	...
	if($totalRows_progs_cursos > 0){
		...
		do { 
	             ...
	             if($row_progs_cursos['program_new']==1){
	         	 ...
	         	 }else if($row_progs_cursos['program_new']==2){
