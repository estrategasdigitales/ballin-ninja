...
$query_progs_cursos = "SELECT * FROM site_programs WHERE program_type = 'curso' AND idioma != 1 AND cancelado = 0 AND periodo = 'o' AND (id_discipline = ".$disciplina." OR id_discipline_alterna  = ".$disciplina." OR id_discipline_alterna_2  = ".$disciplina.") ORDER BY idioma ASC, program_name ASC"; 
