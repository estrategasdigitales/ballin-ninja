...
$query_progs_diplos = "SELECT * FROM site_programs WHERE program_type = 'diplomado' AND cancelado = 0 AND periodo = 'o' AND (id_discipline  = ".$disciplina." OR ".$disciplina." IN(id_discipline_alterna) OR id_discipline_alterna_2 = ".$disciplina.") ORDER BY program_name ASC";
...
$query_progs_cursos = "SELECT * FROM site_programs WHERE program_type = 'curso' AND cancelado = 0 AND periodo = 'o' AND idioma != 1 AND (id_discipline = ".$disciplina." OR id_discipline_alterna  = ".$disciplina." OR id_discipline_alterna_2  = ".$disciplina.") ORDER BY idioma ASC, program_name ASC"; 
...
$query_progs_hp = "SELECT * FROM site_programs WHERE program_type = 'programahp' AND cancelado = 0 AND periodo = 'o' AND id_discipline = ".$disciplina." OR id_discipline_alterna = ".$disciplina." ORDER BY program_name ASC";
...
$query_progs_cursos_i = "SELECT * FROM site_programs WHERE program_type = 'curso' AND idioma = 1 AND cancelado = 0 AND id_discipline = ".$disciplina." AND id_program IN (SELECT id_program FROM site_fechas_idiomas WHERE inicio >= '2013-06-01') ORDER BY idioma ASC, program_name ASC";
