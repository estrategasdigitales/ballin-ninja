...
$query_progs_progs = "SELECT * FROM site_programs_dupl WHERE program_type = 'programa' AND cancelado = 0 AND id_discipline = ".$disciplina." AND id_program IN (SELECT id_program FROM site_fechas_ini WHERE fecha >= '2012-12-06' AND periodo = 'p') ORDER BY idioma ASC, program_name ASC";
...
$query_progs_hp = "SELECT * FROM site_programs_dupl WHERE program_type = 'programahp'  AND cancelado = 0 AND id_discipline = ".$disciplina." OR id_discipline_alterna = ".$disciplina." AND id_program IN (SELECT id_program FROM site_fechas_ini WHERE fecha >= '2013-00-00' AND periodo = 'p') ORDER BY idioma ASC, program_name ASC";
