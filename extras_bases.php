...
<div id="espacio" style="width:5%;float:left">
 ...
 ?>
	   ...
	   <!--<p style="width: 70%;">*Descuento no acumulable con otras promociones. *Promocion válida del 11 al 14 de febrero de 2013.
	  	...
	  	*Valido para todos los programas primavera 2013.</p>-->
	  	...
	  	<div id="contenedor_forms" style="width: 100%; top: 0px; position:relative; height: 215px;">
			...
			<a id="bases" style="color:red; margin: 240px;">* Consulta las bases</a>
		</div>
	...
	<div id="opacity" style="display:none; position:absolute; width:100%; height:132%; background-color:black; opacity:0.5; z-index:3;">
	</div>
	...
	$(document).mouseup(function (e)
{
	...
	$('#bases').click(function(){
		/*$('body').css({'background-color':'#FFF;', 'opacity':'0.5', 'width':'100%', 'height':'100%', 'position':'absolute'})*/
		/*$('#opacity').show()	*/
		$('.bases').show()	
